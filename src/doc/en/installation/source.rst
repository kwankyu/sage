...
8. Type ``./configure``, followed by any options that you wish to use.
    ...
    packages <https://github.com/sagemath/sage/issues/27330>`__, Sage is
    able to detect whether an installed system package is suitable for
    use with Sage; in that case, Sage will not build another copy from
    source.

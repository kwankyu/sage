...
def AffineSpace(n, R=None, names=None, ambient_projective_space=None,
    ...
    Use the divide operator for base extension::
        ...
        sage: AffineSpace(5, names='x')/GF(17)                                          # needs sage.rings.finite_rings
    ...
    There is also an affine space associated to each polynomial ring::
        ...
        sage: R = GF(7)['x, y, z']                                                      # needs sage.rings.finite_rings
        sage: A = AffineSpace(R); A                                                     # needs sage.rings.finite_rings
        Affine Space of dimension 3 over Finite Field of size 7
        sage: A.coordinate_ring() is R                                                  # needs sage.rings.finite_rings
        True
...
class AffineSpace_generic(AmbientSpace, AffineScheme):
    ...
    def rational_points(self, F=None):
        ...
        EXAMPLES::
            ...
            sage: A = AffineSpace(1, GF(3))                                             # needs sage.rings.finite_rings
            sage: A.rational_points()                                                   # needs sage.rings.finite_rings
            [(0), (1), (2)]
            sage: A.rational_points(GF(3^2, 'b'))                                       # needs sage.rings.finite_rings
            [(0), (b), (b + 1), (2*b + 1), (2), (2*b), (2*b + 2), (b + 2), (1)]

            sage: AffineSpace(2, ZZ).rational_points(GF(2))                             # needs sage.rings.finite_rings
            [(0, 0), (0, 1), (1, 0), (1, 1)]
        ...
        TESTS::
            ...
            sage: AffineSpace(1, GF(3)).rational_points(ZZ)                             # needs sage.rings.finite_rings
            Traceback (most recent call last):
            ...
    ...
    def change_ring(self, R):
        ...
        EXAMPLES::
            ...
            Affine Space of dimension 3 over Rational Field
            sage: AQ.change_ring(GF(5))                                                 # needs sage.rings.finite_rings
...
class AffineSpace_field(AffineSpace_generic):
    def _point(self, *args, **kwds):
        ...
        TESTS::
            ...
            sage: P2.<x,y,z> = AffineSpace(3, GF(3))                                    # needs sage.rings.finite_rings

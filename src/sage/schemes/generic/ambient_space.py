...
class AmbientSpace(Scheme):
    ...
    def base_extend(self, R):
        ...
        EXAMPLES::
            ...
            sage: PQ.base_extend(GF(5))                                                 # needs sage.rings.finite_rings
            Traceback (most recent call last):
            ...
    ...
    def ambient_space(self):
        ...
        EXAMPLES::
            ...
            sage: A.ambient_space()                                                     # needs sage.rings.finite_rings
    ...
    def identity_morphism(self):
        ...
        EXAMPLES::
            ...
            sage: A = AffineSpace(2, GF(3))                                             # needs sage.rings.finite_rings
            sage: A.identity_morphism()                                                 # needs sage.rings.finite_rings
    ...
    def gens(self):
        ...
        EXAMPLES::
            ...
            sage: P.<x, y, z> = ProjectiveSpace(2, GF(5))                               # needs sage.rings.finite_rings
            sage: P.gens()                                                              # needs sage.rings.finite_rings
            (x, y, z)
        """

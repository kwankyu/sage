...
class ProjectiveCurve(Curve_generic, AlgebraicScheme_subscheme_projective):
    ...
    EXAMPLES::
        ...
        sage: P.<x,y,z,w,u> = ProjectiveSpace(GF(7), 4)                                 # needs sage.rings.finite_rings
    ...
    def projection(self, P=None, PS=None):
        ...
        ::
            ...
            sage: P.<x,y,z,w> = ProjectiveSpace(GF(2), 3)                               # needs sage.rings.finite_rings
    ...
    def plane_projection(self, PP=None):
        ...
        ::
            ...
            sage: P.<x,y,z> = ProjectiveSpace(GF(17), 2)                                # needs sage.rings.finite_rings
...
class ProjectivePlaneCurve(ProjectiveCurve):
    ...
    A projective plane curve defined over an algebraic closure of `\QQ`::
        ...
        sage: set_verbose(-1)  # suppress warnings for slow computation                 # needs sage.rings.number_field
    ...
    def is_singular(self, P=None):
        ...
        Showing that :trac:`12187` is fixed::
            ...
            sage: F.<X,Y,Z> = GF(2)[]                                                   # needs sage.rings.finite_rings
            sage: G = Curve(X^2 + Y*Z)                                                  # needs sage.rings.finite_rings
    ...
    def is_ordinary_singularity(self, P):
        ...
        ::
            ...
            ....:              + 4*x^6*y^3 + 2*x^8*y])
            sage: Q = P([0,1,1])                                                        # needs sage.rings.number_field
    ...
    def excellent_position(self, Q):
        ...
        ::
            ...
            ....:              + 4*z^6*y^3 + 2*z^8*y])
            sage: Q = P([1,0,0])                                                        # needs sage.rings.number_field
        ...
        ::
            ...
            sage: P.<x,y,z> = ProjectiveSpace(QQbar, 2)                                 # needs sage.rings.number_field
            sage: C = Curve([(-1/4*a)*x^3 + (-3/4*a)*x^2*y                              # needs sage.rings.number_field
...
class ProjectiveCurve_field(ProjectiveCurve, AlgebraicScheme_subscheme_projective_field):
    ...
    def arithmetic_genus(self):
        ...
        ::
            ...
            sage: P.<x,y,z,w,t> = ProjectiveSpace(GF(7), 4)                             # needs sage.rings.finite_rings

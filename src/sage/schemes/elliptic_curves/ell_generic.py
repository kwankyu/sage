...
class EllipticCurve_generic(WithEqualityById, plane_curve.ProjectivePlaneCurve):
    ...
    def _magma_init_(self, magma):
        ...
        EXAMPLES::
            ...
            sage: magma(E)                      # optional - magma                      # needs sage.rings.finite_rings
    ...
    def _reduce_point(self, R, p):
        ...
        function tells us this::
            ...
            sage: E11(S)                                                                # needs sage.rings.finite_rings
            (0 : 1 : 0)
    ...
    def lift_x(self, x, all=False, extend=False):
        ...
        We can perform these operations over finite fields too::
            ...
            sage: E = EllipticCurve('37a').change_ring(GF(17)); E                       # needs sage.rings.finite_rings
...
# ###########################################################
    ...
    def automorphisms(self, field=None):
        ...
        Random testing::
            ...
            sage: F.<t> = GF((p,k))                                                     # needs sage.rings.finite_rings
            ...
            True
            sage: sorted(Aut) == Aut                                                    # needs sage.rings.finite_rings
            True
        """
    ...
    def _p_primary_torsion_basis(self, p, m=None):
        ...
        EXAMPLES::
            ...
            [[(5 : -6 : 1), 1]]
            sage: x = polygen(ZZ, 'x')
            sage: K.<t> = NumberField(x^4 + x^3 + 11*x^2 + 41*x + 101)                  # needs sage.rings.number_field
            sage: EK = E.base_extend(K)                                                 # needs sage.rings.number_field
            sage: EK._p_primary_torsion_basis(5)        # long time (2s on sage.math, 2011), needs sage.rings.number_field
            ...
            sage: E._p_primary_torsion_basis(7,2)       # long time (8s on sage.math, 2011), needs sage.rings.number_field
            [[(0 : z^7 : 1), 1],
        ...
        This shows that the bug at :trac:`4937` is fixed::
            ...
            sage: [t[1] for t in E._p_primary_torsion_basis(2)]         # long time (3s on sage.math, 2011), needs sage.rings.finite_rings
            [16, 1]
        """
        p = rings.Integer(p)
        if not p.is_prime():
    ...
    def pari_curve(self):
        ...
        EXAMPLES::
            ...
            sage: e = E.pari_curve()                                                    # needs sage.libs.pari
            sage: type(e)                                                               # needs sage.libs.pari
            <... 'cypari2.gen.Gen'>
            sage: e.type()                                                              # needs sage.libs.pari
            't_VEC'
            sage: e.disc()                                                              # needs sage.libs.pari
            37.0000000000000

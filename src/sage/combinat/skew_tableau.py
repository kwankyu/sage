...
class StandardSkewTableaux_all(StandardSkewTableaux):
    ...
    def __iter__(self):
        ...
        EXAMPLES::
            ...
            sage: [next(it) for x in range(10)]                                         # needs sage.graphs
            [[],
             [[1]],
...
class StandardSkewTableaux_size(StandardSkewTableaux):
    ...
    def __iter__(self):
        ...
        EXAMPLES::
            ...
            sage: StandardSkewTableaux(2).list()                                        # needs sage.graphs
            [[[1, 2]], [[1], [2]], [[None, 2], [1]], [[None, 1], [2]]]

            sage: StandardSkewTableaux(3).list()                                        # needs sage.graphs
            [[[1, 2, 3]],
             [[1, 2], [3]], [[1, 3], [2]],
...
class StandardSkewTableaux_shape(StandardSkewTableaux):
    ...
    def __iter__(self):
        ...
        EXAMPLES::
            ...
            sage: StandardSkewTableaux([[3, 2, 1], [1, 1]]).list()                      # needs sage.graphs
            [[[None, 2, 3], [None, 4], [1]],
             [[None, 1, 2], [None, 3], [4]],
             [[None, 1, 2], [None, 4], [3]],
             [[None, 1, 3], [None, 4], [2]],

...
class Subsets_s(Parent):
    ...
    EXAMPLES::
        ...
        sage: S = Subsets(Subsets(Subsets(GF(3)))); S                                   # needs sage.rings.finite_rings
        Subsets of Subsets of Subsets of Finite Field of size 3
        sage: S.cardinality()                                                           # needs sage.rings.finite_rings
        115792089237316195423570985008687907853269984665640564039457584007913129639936
        sage: S.unrank(3149254230)  # random                                            # needs sage.rings.finite_rings
    ...
    def underlying_set(self):
        ...
        EXAMPLES::
            ...
            sage: Subsets(GF(13)).underlying_set()                                      # needs sage.rings.finite_rings

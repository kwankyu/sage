...
class DCompletePoset(FiniteJoinSemilattice):
    ...
    def _hooks(self):
        ...
        TESTS::
            ...
            {0: 1, 1: 2, 2: 2, 3: 3}
            sage: from sage.combinat.posets.poset_examples import Posets
            sage: P = DCompletePoset(Posets.YoungDiagramPoset(Partition([3,2,1]))._hasse_diagram.reverse())             # needs sage.combinat
            sage: P._hooks                                                              # needs sage.combinat
    ...
    def get_hooks(self):
        ...
        EXAMPLES::
            ...
            {0: 1, 1: 2, 2: 2, 3: 3}
            sage: from sage.combinat.posets.poset_examples import Posets
            sage: YDP321 = Posets.YoungDiagramPoset(Partition([3,2,1]))                 # needs sage.combinat
            sage: P = DCompletePoset(YDP321._hasse_diagram.reverse())                   # needs sage.combinat
            sage: P.get_hooks()                                                         # needs sage.combinat
            {0: 5, 1: 3, 2: 1, 3: 3, 4: 1, 5: 1}
        """
    ...
    def hook_product(self):
        ...
        TESTS::
            ...
            sage: P.hook_product()
            12
            sage: P = DCompletePoset(posets.YoungDiagramPoset(Partition([3,2,1]),       # needs sage.combinat
            ....:                    dual=True))
            sage: P.hook_product()                                                      # needs sage.combinat
            45
        """

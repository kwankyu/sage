...
class LinearExtensionOfPoset(ClonableArray,
    ...
    def is_supergreedy(self):
        ...
        EXAMPLES::
            ...
            sage: for l in P.linear_extensions():                                       # needs sage.modules sage.rings.finite_rings
            ....:     if l.is_supergreedy():
            ....:         print(l)
            [1, 4, 3, 0, 5, 6, 2]
            [0, 1, 4, 3, 5, 6, 2]
    ...
    def tau(self, i):
        ...
        EXAMPLES::
            ...
            sage: l.tau(1)
            [2, 1, 3, 4]
            sage: for p in L:                                                           # needs sage.modules sage.rings.finite_rings
            ....:     for i in range(1,4):
...
class LinearExtensionsOfPoset(UniqueRepresentation, Parent):
    ...
    EXAMPLES::
        ...
        sage: L.cardinality()
        5
        sage: L.list()                                                                  # needs sage.modules sage.rings.finite_rings
    ...
    def __iter__(self):
        ...
        EXAMPLES::
            ...
            sage: P = Poset((elms, rels), linear_extension=True)
            sage: L = P.linear_extensions()
            sage: list(L)                                                               # needs sage.modules sage.rings.finite_rings
            [[1, 2, 3, 4], [2, 1, 3, 4], [2, 1, 4, 3], [1, 4, 2, 3], [1, 2, 4, 3]]
        """
...
class LinearExtensionsOfPosetWithHooks(LinearExtensionsOfPoset):
    ...
    def cardinality(self):
        ...
        EXAMPLES::
            ...
            sage: P = Posets.YoungDiagramPoset(Partition([3,2]), dual=True)             # needs sage.combinat

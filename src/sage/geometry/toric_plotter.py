...
def color_list(color, n):
    ...
    EXAMPLES::
        ...
        sage: color_list("grey", 1)                                                     # needs sage.plot
        [RGB color (0.5019607843137255, 0.5019607843137255, 0.5019607843137255)]
        sage: len(color_list("grey", 3))                                                # needs sage.plot
        3
        sage: L = color_list("rainbow", 3)                                              # needs sage.plot
        sage: L                                                                         # needs sage.plot
        [RGB color (1.0, 0.0, 0.0),
         RGB color (0.0, 1.0, 0.0),
         RGB color (0.0, 0.0, 1.0)]
        sage: color_list(L, 3)                                                          # needs sage.plot
        [RGB color (1.0, 0.0, 0.0),
         RGB color (0.0, 1.0, 0.0),
         RGB color (0.0, 0.0, 1.0)]
        sage: color_list(L, 4)                                                          # needs sage.plot
        Traceback (most recent call last):
        ...

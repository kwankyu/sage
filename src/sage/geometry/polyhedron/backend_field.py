...
class Polyhedron_field(Polyhedron_base):
    ...
    def _is_zero(self, x):
        ...
        EXAMPLES::
            ...
            sage: p._is_zero(0)                                                         # needs sage.rings.number_field
            True
    ...
    def _is_nonneg(self, x):
        ...
        EXAMPLES::
            ...
            sage: p = Polyhedron([(sqrt(3),sqrt(2))], base_ring=AA)                     # needs sage.rings.number_field
            sage: p._is_nonneg(1)                                                       # needs sage.rings.number_field
            True
    ...
    def _is_positive(self, x):
        ...
        EXAMPLES::
            ...
            sage: p = Polyhedron([(sqrt(3),sqrt(2))], base_ring=AA)                     # needs sage.rings.number_field
            sage: p._is_positive(1)                                                     # needs sage.rings.number_field
            True
    ...
    def _init_Vrepresentation_backend(self, Vrep):
        ...
        EXAMPLES::
            ...
            sage: p.Hrepresentation()                                                   # needs sage.rings.number_field

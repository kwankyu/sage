...
class EuclideanGroup(AffineGroup):
    ...
    TESTS::
        ...
        True
        sage: G = EuclideanGroup(2, GF(5)); G                                                       # needs sage.rings.finite_rings
    ...
    def _latex_(self):
        ...
        EXAMPLES::
            ...
            sage: G = EuclideanGroup(6, GF(5))                                                      # needs sage.rings.finite_rings
    ...
    def _repr_(self):
        ...
        EXAMPLES::
            ...
            sage: EuclideanGroup(6, GF(5))                                                          # needs sage.rings.finite_rings
    ...
    def random_element(self):
        ...
        EXAMPLES::
            ...
            sage: G = EuclideanGroup(4, GF(3))                                                      # needs sage.rings.finite_rings
        ...
        TESTS::
            ...
            sage: G.random_element().A().is_unitary()                                               # needs sage.rings.finite_rings
            True
        """
        while True:

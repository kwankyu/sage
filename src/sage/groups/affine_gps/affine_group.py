...
class AffineGroup(UniqueRepresentation, Group):
    ...
    def __init__(self, degree, ring):
        ...
        TESTS::
            ...
            sage: G = AffineGroup(2, GF(5)); G                                          # needs sage.rings.finite_rings
    ...
    def _latex_(self):
        ...
        EXAMPLES::
            ...
            sage: G = AffineGroup(6, GF(5))                                             # needs sage.rings.finite_rings
    ...
    def _repr_(self):
        ...
        EXAMPLES::
            ...
            sage: AffineGroup(6, GF(5))                                                 # needs sage.rings.finite_rings
    ...
    def matrix_space(self):
        ...
        EXAMPLES::
            ...
            sage: G = AffineGroup(3, GF(5))                                             # needs sage.rings.finite_rings
            sage: G.matrix_space()                                                      # needs sage.rings.finite_rings
    ...
    def vector_space(self):
        ...
        EXAMPLES::
            ...
            sage: G = AffineGroup(3, GF(5))                                             # needs sage.rings.finite_rings
            sage: G.vector_space()                                                      # needs sage.rings.finite_rings
    ...
    def linear_space(self):
        ...
        EXAMPLES::
            ...
            sage: G = AffineGroup(3, GF(5))                                             # needs sage.rings.finite_rings
            sage: G.linear_space()                                                      # needs sage.rings.finite_rings
    ...
    def linear(self, A):
        ...
        EXAMPLES::
            ...
            sage: G = AffineGroup(3, GF(5))                                             # needs sage.rings.finite_rings
            sage: G.linear([1,2,3,4,5,6,7,8,0])                                         # needs sage.rings.finite_rings
                  [1 2 3]     [0]
            x |-> [4 0 1] x + [0]
                  [2 3 0]     [0]
        """
    ...
    def translation(self, b):
        ...
        EXAMPLES::
            ...
            sage: G = AffineGroup(3, GF(5))                                             # needs sage.rings.finite_rings
            sage: G.translation([1,4,8])                                                # needs sage.rings.finite_rings
                  [1 0 0]     [1]
            x |-> [0 1 0] x + [4]
                  [0 0 1]     [3]
        """
    ...
    def reflection(self, v):
        ...
        EXAMPLES::
            ...
            sage: G = AffineGroup(3, QQ)                                                # needs sage.rings.finite_rings
            sage: G.reflection([1,0,0])                                                 # needs sage.rings.finite_rings
                  [-1  0  0]     [0]
            x |-> [ 0  1  0] x + [0]
                  [ 0  0  1]     [0]
            sage: G.reflection([3,4,-5])                                                # needs sage.rings.finite_rings
                  [ 16/25 -12/25    3/5]     [0]
    ...
    def random_element(self):
        ...
        EXAMPLES::
            ...
            sage: G = AffineGroup(4, GF(3))                                             # needs sage.rings.finite_rings
    ...
    def _an_element_(self):
        ...
        TESTS::
            ...
            sage: G = AffineGroup(4,5)                                                  # needs sage.rings.finite_rings

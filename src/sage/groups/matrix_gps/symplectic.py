...
def Sp(n, R, var='a', invariant_form=None):
    ...
    EXAMPLES::
        ...
        sage: Sp(4, 5)                                                                  # needs sage.rings.finite_rings
        ...
        sage: Sp(3, GF(7))                                                              # needs sage.rings.finite_rings
    ...
    Using the ``invariant_form`` option::
        ...
        sage: Sp(4,3, invariant_form=[[0,0,0,1],[0,0,1,0],[0,2,0,0], [2,0,0,0]])        # needs sage.rings.finite_rings
        Traceback (most recent call last):
        ...
    ...
    TESTS::
        ...
        sage: G = Sp(4,5)                                                               # needs sage.rings.finite_rings
...
class SymplecticMatrixGroup_generic(NamedMatrixGroup_generic):
    ...
    EXAMPLES::
        ...
        sage: Sp43 = Sp(4,3); Sp43                                                      # needs sage.rings.finite_rings
        Symplectic Group of degree 4 over Finite Field of size 3
        sage: latex(Sp43)                                                               # needs sage.rings.finite_rings
    ...
    def _check_matrix(self, x, *args):
        ...
        EXAMPLES::
            ...
            sage: G = Sp(4, GF(5))                                                      # needs sage.rings.finite_rings

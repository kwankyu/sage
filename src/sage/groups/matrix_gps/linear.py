...
EXAMPLES::
    ...
    sage: G = SL(2, GF(3)); G                                                           # needs sage.rings.finite_rings
    ...
    sage: G = SL(6, GF(5))                                                              # needs sage.rings.finite_rings
...
def SL(n, R, var='a'):
    ...
    EXAMPLES::
        ...
        sage: SL(3, GF(2))                                                              # needs sage.rings.finite_rings
        Special Linear Group of degree 3 over Finite Field of size 2
        sage: G = SL(15, GF(7)); G                                                      # needs sage.rings.finite_rings
...
class LinearMatrixGroup_generic(NamedMatrixGroup_generic):
    ...
    def _check_matrix(self, x, *args):
        ...
        EXAMPLES::
            ...
            sage: G = SL(2, GF(5))                                                      # needs sage.rings.finite_rings

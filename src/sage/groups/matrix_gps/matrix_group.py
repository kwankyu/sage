...
Loading, saving, ... works::
    ...
    sage: G = GL(2,5); G                                                                # needs sage.rings.finite_rings
...
class MatrixGroup_base(Group):
    ...
    TESTS::
        ...
        sage: G = SO(3, GF(11)); G                                                      # needs sage.rings.finite_rings
        Special Orthogonal Group of degree 3 over Finite Field of size 11
        sage: G.category()                                                              # needs sage.rings.finite_rings
    ...
    def as_matrix_group(self):
        ...
        EXAMPLES::
            ...
            sage: G = GO(3,GF(5))                                                       # needs sage.rings.finite_rings
            sage: G.as_matrix_group()                                                   # needs sage.rings.finite_rings
    ...
    def _latex_(self):
        ...
        EXAMPLES::
            ...
            sage: MS = MatrixSpace(GF(5), 2, 2)                                         # needs sage.rings.finite_rings
            sage: G = MatrixGroup(MS([[1,2], [-1,1]]), MS([[1,1], [0,1]]))              # needs sage.rings.finite_rings

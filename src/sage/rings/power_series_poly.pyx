...
cdef class PowerSeries_poly(PowerSeries):
    ...
    def polynomial(self):
        ...
        EXAMPLES::
            ...
            sage: f = 3 - t^3 + O(t^5)                                                  # needs sage.rings.finite_rings
            sage: f.polynomial()                                                        # needs sage.rings.finite_rings
            6*t^3 + 3
        """
        return self.__f
    ...
    def __call__(self, *x, **kwds):
        ...
        A series defined over another ring can be substituted::
            ...
            sage: S.<u> = GF(7)[[]]                                                     # needs sage.rings.finite_rings
            sage: f(2*u + u^3 + O(u^5))                                                 # needs sage.rings.finite_rings
    ...
    cpdef _rmul_(self, Element c):
        ...
        EXAMPLES::
            ...
            sage: R.<t> = GF(7)[[]]                                                     # needs sage.rings.finite_rings
            sage: f = t + 3*t^4 + O(t^11)                                               # needs sage.rings.finite_rings
    ...
    cpdef _lmul_(self, Element c):
        ...
        EXAMPLES::
            ...
            sage: R.<t> = GF(11)[[]]                                                    # needs sage.rings.finite_rings
            sage: f = 1 + 3*t^4 + O(t^120)                                              # needs sage.rings.finite_rings
            sage: 2 * f                                                                 # needs sage.rings.finite_rings
            2 + 6*t^4 + O(t^120)
        """
    ...
    def truncate_powerseries(self, long prec):
        ...
        EXAMPLES::
            ...
            sage: f = 1/(1+I+O(I^8)); f                                                 # needs sage.rings.finite_rings
            1 + I + I^2 + I^3 + I^4 + I^5 + I^6 + I^7 + O(I^8)
            sage: f.truncate_powerseries(5)                                             # needs sage.rings.finite_rings
    ...
    def _derivative(self, var=None):
        ...
        TESTS::
            ...
            sage: t.derivative(x)                                                       # needs sage.symbolic
            Traceback (most recent call last):
            ...

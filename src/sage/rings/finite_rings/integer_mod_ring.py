...
def is_IntegerModRing(x):
    ...
    EXAMPLES::
        ...
        True
        sage: is_IntegerModRing(GF(13))                                                 # needs sage.rings.finite_rings
        True
...
class IntegerModRing_generic(quotient_ring.QuotientRing_generic, sage.rings.abc.IntegerModRing):
    ...
    ::
        ...
        False
        sage: def pow(i): return a**i                                                   # needs sage.groups
    ...
    ::
        ...
        sage: def powa(i): return a**i                                                  # needs sage.groups
        sage: def powb(i): return b**i                                                  # needs sage.groups
...
In the latter case, please inform the developers.""".format(self.order()))
    ...
    def field(self):
        ...
        EXAMPLES::
            ...
            sage: R = Integers(7); R
            Ring of integers modulo 7
            sage: R.field()                                                             # needs sage.rings.finite_rings
            Finite Field of size 7
            sage: R = Integers(9)
            sage: R.field()                                                             # needs sage.rings.finite_rings
            Traceback (most recent call last):
    ...
    def multiplicative_group_is_cyclic(self):
        ...
        EXAMPLES::
            ...
            True
            sage: Integers(8).multiplicative_group_is_cyclic()                          # needs sage.libs.pari
            False
            sage: Integers(4).multiplicative_group_is_cyclic()                          # needs sage.libs.pari
            True
    ...
    def multiplicative_generator(self):
        ...
        EXAMPLES::
            ...
            sage: R.multiplicative_generator()                                          # needs sage.libs.pari
            2
            sage: Integers(8).multiplicative_generator()                                # needs sage.libs.pari
            Traceback (most recent call last):
            ...
    ...
    def quadratic_nonresidue(self):
        ...
        EXAMPLES::
            ...
            3
            sage: R(3).is_square()                                                      # needs sage.libs.pari
            False
        """
        try:
    ...
    def square_roots_of_one(self):
        ...
        EXAMPLES::
            ...
            [1, 511, 513, 1023]
            sage: R.square_roots_of_one()                                               # needs sage.libs.pari
            (1, 511, 513, 1023)
    ...
    def _element_constructor_(self, x):
        ...
        The following test refers to :trac:`6468`::
            ...
            sage: P = foo_parent()
            sage: F = foo(P)
            sage: GF(2)(F)                                                              # needs sage.rings.finite_rings
            Traceback (most recent call last):
            ...
    ...
    def __richcmp__(self, other, op):
        ...
        EXAMPLES::
            ...
            (True, False, False)
            sage: F = GF(11); F                                                         # needs sage.rings.finite_rings
            Finite Field of size 11
            sage: Z11 == F                                                              # needs sage.rings.finite_rings
            False
        ...
        In :trac:`15229`, the following was implemented::
            ...
            True
            sage: R2 == GF(5)                                                           # needs sage.rings.finite_rings
            False

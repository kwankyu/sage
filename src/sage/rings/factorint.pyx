...
cpdef factor_aurifeuillian(n, check=True):
    ...
    EXAMPLES::
        ...
        sage: fa(2^6 + 1)                                                               # needs sage.libs.pari
        [5, 13]
        sage: fa(2^58 + 1)                                                              # needs sage.libs.pari
        [536838145, 536903681]
        sage: fa(3^3 + 1)                                                               # needs sage.libs.pari
        [4, 1, 7]
        sage: fa(5^5 - 1)                                                               # needs sage.libs.pari
        [4, 11, 71]
        sage: prod(_) == 5^5 - 1                                                        # needs sage.libs.pari
        True
        sage: fa(2^4 + 1)                                                               # needs sage.libs.pari
        [17]
        sage: fa((6^2*3)^3 + 1)                                                         # needs sage.libs.pari
        [109, 91, 127]

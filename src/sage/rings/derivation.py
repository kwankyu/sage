...
class RingDerivationWithoutTwist_wrapper(RingDerivationWithoutTwist):
    ...
    def __init__(self, parent, arg=None):
        ...
        TESTS::
            ...
            sage: S = R.quo([x^5, y^5])                                                 # needs sage.rings.finite_rings
            sage: M = S.derivation_module()                                             # needs sage.rings.finite_rings
            sage: der = M.random_element()                                              # needs sage.rings.finite_rings
            sage: isinstance(der, RingDerivationWithoutTwist_wrapper)                   # needs sage.rings.finite_rings
            True

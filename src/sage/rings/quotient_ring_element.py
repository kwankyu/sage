...
class QuotientRingElement(RingElement):
    ...
    def _latex_(self):
        ...
        EXAMPLES::
            ...
            sage: latex(a)                                                              # needs sage.libs.singular
            a
        """
        from sage.structure.parent_gens import localvars
        P = self.parent()
    ...
    def _div_(self, right):
        ...
        actually describes what happens when the result of division is not defined)::
            ...
            sage: R.<x1,x2> = QQ[]
            sage: S = R.quotient_ring( R.ideal(x2**2 + x1 - 2, x1**2 - 1) )             # needs sage.libs.singular
    ...
    def _richcmp_(self, other, op):
        ...
        See :trac:`7797`::
            ...
            sage: Q = F.quo(I)                                                          # needs sage.libs.singular
            sage: Q.0^4    # indirect doctest                                           # needs sage.libs.singular

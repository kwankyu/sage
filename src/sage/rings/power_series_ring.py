...
class PowerSeriesRing_generic(UniqueRepresentation, ring.CommutativeRing, Nonexact):
    ...
    def _coerce_impl(self, x):
        ...
        compatible base rings::
            ...
            sage: R.<t> = PowerSeriesRing(GF(7)['w'])                                   # needs sage.rings.finite_rings
            sage: S = PowerSeriesRing(ZZ, 't')
            sage: f = S([1,2,3,4]); f
            1 + 2*t + 3*t^2 + 4*t^3
            sage: g = R.coerce(f); g                                                    # needs sage.rings.finite_rings
            1 + 2*t + 3*t^2 + 4*t^3
            ...
            sage: S.coerce(g)                                                           # needs sage.rings.finite_rings
            Traceback (most recent call last):
            ...
    ...
    def base_extend(self, R):
        ...
        EXAMPLES::
            ...
            sage: R.<T> = GF(7)[[]]; R                                                  # needs sage.rings.finite_rings
            Power Series Ring in T over Finite Field of size 7
            sage: R.change_ring(ZZ)                                                     # needs sage.rings.finite_rings
            Power Series Ring in T over Integer Ring
            sage: R.base_extend(ZZ)                                                     # needs sage.rings.finite_rings
            Traceback (most recent call last):
            ...
    ...
    def change_ring(self, R):
        ...
        EXAMPLES::
            ...
            sage: R.change_ring(GF(7))                                                  # needs sage.rings.finite_rings
            Power Series Ring in T over Finite Field of size 7
            sage: R.base_extend(GF(7))                                                  # needs sage.rings.finite_rings
            Traceback (most recent call last):
            ...
            TypeError: no base extension defined
    ...
    def residue_field(self):
        ...
        EXAMPLES::
            ...
            sage: R.<x> = PowerSeriesRing(GF(17))                                       # needs sage.rings.finite_rings
            sage: R.residue_field()                                                     # needs sage.rings.finite_rings
...
class PowerSeriesRing_over_field(PowerSeriesRing_domain):
    ...
    def fraction_field(self):
        ...
        EXAMPLES::
            ...
            sage: R.<t> = PowerSeriesRing(GF(7))                                        # needs sage.rings.finite_rings
            sage: R.fraction_field()                                                    # needs sage.rings.finite_rings
            Laurent Series Ring in t over Finite Field of size 7
            sage: Frac(R)                                                               # needs sage.rings.finite_rings
            Laurent Series Ring in t over Finite Field of size 7
        """

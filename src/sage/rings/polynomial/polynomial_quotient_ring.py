...
class PolynomialQuotientRing_generic(QuotientRing_generic):
    ...
    def _coerce_map_from_(self, R):
        ...
        TESTS::
            ...
            sage: P5.<x> = GF(5)[]                                                      # needs sage.rings.finite_rings
    ...
    def construction(self):
        ...
        EXAMPLES::
            ...
            True
            sage: P.<t> = GF(3)[]                                                       # needs sage.rings.finite_rings
    ...
    def is_finite(self):
        ...
        ::
            ...
            sage: P.<v> = GF(2)[]                                                       # needs sage.rings.finite_rings
    ...
    def degree(self):
        ...
        EXAMPLES::
            ...
            sage: R.<x> = PolynomialRing(GF(3))                                         # needs sage.rings.finite_rings
    ...
    def units(self, proof=True):
        ...
        Note that all the returned values live where we expect them to::
            ...
            sage: # needs sage.libs.pari
            sage: L.<b> = K['y'].quotient(y^3 + 5)                                      # needs sage.rings.number_field
            sage: U = L.units()                                                         # needs sage.rings.number_field
            sage: type(U[0][0])
            <class 'sage.rings.polynomial.polynomial_quotient_ring.PolynomialQuotientRing_field_with_category.element_class'>
            sage: type(U[0][1])
            <class 'sage.rings.integer.Integer'>

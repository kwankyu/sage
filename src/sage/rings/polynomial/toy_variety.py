...
def linear_representation(p, polys):
    ...
    EXAMPLES::
        ...
        sage: R.<x,y> = PolynomialRing(GF(32003))                                       # needs sage.rings.finite_rings
        sage: B = [x^2 + 1, y^2 + 1, x*y + 1]                                           # needs sage.rings.finite_rings
        sage: p = 3*B[0] - 2*B[1] + B[2]                                                # needs sage.rings.finite_rings
        sage: linear_representation(p, B)                                               # needs sage.rings.finite_rings
        [3, 32001, 1]
    """

...
class Ideal_1poly_field(Ideal_pid):
    ...
    def residue_class_degree(self):
        ...
        EXAMPLES::
            ...
            sage: P = R.ideal(t^4 + t + 1)                                              # needs sage.rings.finite_rings
            sage: P.residue_class_degree()                                              # needs sage.rings.finite_rings
            4
        """
    ...
    def residue_field(self, names=None, check=True):
        ...
        EXAMPLES::
            ...
            sage: R.<t> = GF(17)[]; P = R.ideal(t^3 + 2*t + 9)                          # needs sage.rings.finite_rings

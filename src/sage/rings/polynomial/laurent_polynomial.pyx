...
cdef class LaurentPolynomial(CommutativeAlgebraElement):
    ...
    def change_ring(self, R):
        ...
        EXAMPLES::
            ...
            sage: a.change_ring(GF(3))                                                  # needs sage.rings.finite_rings
            2*x^-1 + x^2
    ...
    def map_coefficients(self, f, new_base_ring=None):
        ...
        Examples with different base ring::
            ...
            sage: T.<X,Y> = LaurentPolynomialRing(R, 2)                                 # needs sage.modules sage.rings.finite_rings
            sage: f = r*X + Y                                                           # needs sage.modules sage.rings.finite_rings
            sage: g = f.map_coefficients(h); g                                          # needs sage.modules sage.rings.finite_rings
            (2*s^3 + 2*s^2 + 1)*X + Y
            sage: g.parent()                                                            # needs sage.modules sage.rings.finite_rings
            ...
            sage: g = f.map_coefficients(h, new_base_ring=GF(3)); g                     # needs sage.modules sage.rings.finite_rings
            X - Y
            sage: g.parent()                                                            # needs sage.modules sage.rings.finite_rings
...
cdef class LaurentPolynomial_univariate(LaurentPolynomial):
    ...
    def _polynomial_(self, R):
        ...
        TESTS::
            ...
            sage: Rx = PolynomialRing(GF(2), "x")                                       # needs sage.rings.finite_rings
            sage: p1 = Lx.gen()
            sage: p2 = Lx.zero()
            sage: p3 = Lx.one()
            sage: p4 = Lx.gen()**3 - 3
            ...
            sage: Pxes += [(Rx, Rx.gen())]                                              # needs sage.rings.finite_rings
    ...
    def _symbolic_(self, R):
        ...
        characteristic::
            ...
            sage: R.<w> = LaurentPolynomialRing(GF(7))                                  # needs sage.rings.finite_rings

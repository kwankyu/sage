...
variable indices::
    ...
    sage: P = Permutation(((10,1)))                                                     # needs sage.combinat
    sage: p^P                                                                           # needs sage.combinat
    x_5*x_1^2 + 3*x_1^2*y_10 + 2*x_1^2
    sage: p2^P                                                                          # needs sage.combinat
...
base ring is a field, one can compute Symmetric Groebner Bases::
    ...
    sage: J.groebner_basis()                                                            # needs sage.combinat
...
class InfinitePolynomialRing_sparse(CommutativeRing):
    ...
    def construction(self):
        ...
        EXAMPLES::
            ...
            sage: R.<x,y> = InfinitePolynomialRing(GF(5))                               # needs sage.rings.finite_rings
            sage: R.construction()                                                      # needs sage.rings.finite_rings
    ...
    def is_noetherian(self):
        ...
        TESTS::
            ...
            sage: R = InfinitePolynomialRing(GF(2))                                     # needs sage.rings.finite_rings
            sage: R                                                                     # needs sage.rings.finite_rings
            Infinite polynomial ring in x over Finite Field of size 2
            sage: R.is_noetherian()                                                     # needs sage.rings.finite_rings
            False
    ...
    def is_field(self, *args, **kwds):
        ...
        TESTS::
            ...
            sage: R                                                                     # needs sage.rings.finite_rings
            Infinite polynomial ring in x over Finite Field of size 2
            sage: R.is_field()                                                          # needs sage.rings.finite_rings
            False
    ...
    def gen(self, i=None):
        ...
        EXAMPLES::
            ...
            True
            sage: XX = InfinitePolynomialRing(GF(5))                                    # needs sage.rings.finite_rings
            sage: XX.gen(0) is XX.gen()                                                 # needs sage.rings.finite_rings
            True
        """
    ...
    def order(self):
        ...
        EXAMPLES::
            ...
            sage: R.<x> = InfinitePolynomialRing(GF(2))                                 # needs sage.rings.finite_rings
            sage: R.order()                                                             # needs sage.rings.finite_rings
            +Infinity
        """
        from sage.rings.infinity import Infinity
        return Infinity

...
def PolynomialRing(base_ring, *args, **kwds):
    ...
    **1. PolynomialRing(base_ring, name, ...)**
    ...
    You must specify a name::
        ...
        sage: R.<w> = PolynomialRing(PolynomialRing(GF(7),'k')); R                      # needs sage.rings.finite_rings
    ...
    **3. PolynomialRing(base_ring, n, names, ...)** (where the arguments
    ...
    ::
        ...
        sage: PolynomialRing(GF(7), 'y', 5)                                             # needs sage.rings.finite_rings
    ...
    **Changing variable names**
    ...
    The generic implementation is different in some cases::
        ...
        sage: R = PolynomialRing(GF(2), 'j', implementation="generic"); TestSuite(R).run(skip=['_test_construction', '_test_pickling']); type(R)                # needs sage.rings.finite_rings
        <class 'sage.rings.polynomial.polynomial_ring.PolynomialRing_field_with_category'>
        sage: S = PolynomialRing(GF(2), 'j'); TestSuite(S).run(); type(S)               # needs sage.rings.finite_rings
    ...
    the given arguments, then an error results::
        ...
        sage: R.<x0> = PolynomialRing(GF(2), implementation='GF2X', sparse=True)        # needs sage.rings.finite_rings
        Traceback (most recent call last):
        ...
    ...
    We run the testsuite for various polynomial rings, skipping tests that currently fail::
        ...
        sage: R.<w> = PolynomialRing(PolynomialRing(GF(7),'k')); TestSuite(R).run(); R  # needs sage.rings.finite_rings

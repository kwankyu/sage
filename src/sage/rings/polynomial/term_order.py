...
class TermOrder(SageObject):
    ...
    def magma_str(self):
        ...
        EXAMPLES::
            ...
            sage: P = PolynomialRing(GF(127), 10, names='x', order='degrevlex')         # needs sage.rings.finite_rings
        ...
        ::
            ...
            sage: T = P.term_order()                                                    # needs sage.rings.finite_rings
            sage: T.magma_str()                                                         # needs sage.rings.finite_rings
            '"grevlex"'
        """

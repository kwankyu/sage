...
Coercion from symbolic ring::
    ...
    sage: S = PowerSeriesRing(GF(11),2,'x,y'); S                                        # needs sage.rings.finite_rings
...
class MPowerSeriesRing_generic(PowerSeriesRing_generic, Nonexact):
    ...
    def remove_var(self, *var):
        ...
        EXAMPLES::
            ...
            sage: M = PowerSeriesRing(GF(5),5,'t'); M                                   # needs sage.rings.finite_rings
            Multivariate Power Series Ring in t0, t1, t2, t3, t4
             over Finite Field of size 5
            sage: M.remove_var(M.gens()[3])                                             # needs sage.rings.finite_rings
            Multivariate Power Series Ring in t0, t1, t2, t4
             over Finite Field of size 5

        Removing all variables results in the base ring::

            sage: M.remove_var(*M.gens())                                               # needs sage.rings.finite_rings
    ...
    def _coerce_impl(self, f):
        ...
        EXAMPLES::
            ...
            sage: R2 = R.change_ring(GF(2))                                             # needs sage.rings.finite_rings
            sage: R2(f1)                                                                # needs sage.rings.finite_rings
            v + t*v
            sage: R2(f2)                                                                # needs sage.rings.finite_rings
            u*v^2 + O(t, u, v)^6

...
class IdealMonoid_c(Parent):
    ...
    def _element_constructor_(self, x):
        ...
        EXAMPLES::
            ...
            sage: R.<a> = QuadraticField(-23)                                           # needs sage.rings.number_field
            sage: from sage.rings.ideal_monoid import IdealMonoid
            sage: M = IdealMonoid(R)                                                    # needs sage.rings.number_field
            sage: M(a)   # indirect doctest                                             # needs sage.rings.number_field
            Fractional ideal (a)
            sage: M([a-4, 13])                                                          # needs sage.rings.number_field

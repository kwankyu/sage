...
EXAMPLES::
    ...
    sage: R.base_ring()
    Rational Field
    sage: S = LaurentSeriesRing(GF(17)['x'], 'y')                                       # needs sage.rings.finite_rings
    sage: S                                                                             # needs sage.rings.finite_rings
    Laurent Series Ring in y over
     Univariate Polynomial Ring in x over Finite Field of size 17
    sage: S.base_ring()                                                                 # needs sage.rings.finite_rings
    Univariate Polynomial Ring in x over Finite Field of size 17
...
class LaurentSeriesRing(UniqueRepresentation, CommutativeRing):
    ...
    field::
        ...
        sage: Frac(QQ[['x']])
        Laurent Series Ring in x over Rational Field
        sage: Frac(GF(5)['y'])                                                          # needs sage.rings.finite_rings
    ...
    The appropriate (sub)category is automatically set in this case::
        ...
        sage: F = Frac(R)                                                               # needs sage.rings.finite_rings
    ...
    def _element_constructor_(self, x, n=0, prec=infinity):
        ...
        ::
            ...
            sage: L(t*I) / L(t^3+I*2*t)                                                 # needs sage.rings.number_field sage.rings.padics sage.symbolic
            1/2 + 1/4*I*u^2 - 1/8*u^4 - 1/16*I*u^6 + 1/32*u^8 +
            1/64*I*u^10 - 1/128*u^12 - 1/256*I*u^14 + 1/512*u^16 +
            1/1024*I*u^18 + O(u^20)
        ...
        Check that :trac:`28993` is fixed::
            ...
            sage: qexp_eta(S, prec=30)                                                  # needs sage.rings.padics
    ...
    def random_element(self, algorithm='default'):
        ...
        EXAMPLES::
            ...
            sage: S.<s> = LaurentSeriesRing(GF(3))                                      # needs sage.rings.finite_rings
            sage: S.random_element()  # random                                          # needs sage.rings.finite_rings
    ...
    def characteristic(self):
        ...
        EXAMPLES::
            ...
            sage: R.<x> = LaurentSeriesRing(GF(17))                                     # needs sage.rings.finite_rings

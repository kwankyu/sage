...
of degree `g`, which is the genus of the function field::
    ...
    sage: J
    Jacobian of Function field in z defined by z^3 + 23*y^2*z + 6 over Finite Field of size 29 (Hess model)
...
class JacobianGroupEmbedding(Map):
    ...
    EXAMPLES::
        ...
        Jacobian group embedding map:
          From: Group of rational points of Jacobian over Finite Field of size 17 (Hess model)
          To:   Group of rational points of Jacobian over Finite Field in z3 of size 17^3 (Hess model)
    """
...
class JacobianGroup(UniqueRepresentation, JacobianGroup_base):
    ...
    EXAMPLES::
        ...
        sage: J = C.jacobian(model='hess', base_div=b)
        sage: J.group()
        Group of rational points of Jacobian over Finite Field of size 17 (Hess model)
    """
...
class Jacobian(UniqueRepresentation, Jacobian_base):
    ...
    def _repr_(self):
        ...
        TESTS::
            ...
            sage: b = C([0,1,0]).place()
            sage: C.jacobian(model='hess', base_div=b)
            Jacobian of Function field in z defined by z^3 + 10*y^2*z + 7 over Finite Field of size 17 (Hess model)
        """
        r = super()._repr_()
        return r + ' (Hess model)'

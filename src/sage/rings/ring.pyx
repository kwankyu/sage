...
cdef class Ring(ParentWithGens):
    ...
    Check that categories correctly implement `is_finite` and `cardinality`::
        ...
        sage: R.is_finite()                                                             # needs sage.rings.finite_rings
        False
    ...
    def base_extend(self, R):
        ...
        EXAMPLES::
            ...
            sage: QQ.base_extend(GF(7))                                                 # needs sage.rings.finite_rings
            Traceback (most recent call last):
            ...
            TypeError: no base extension defined
            sage: ZZ.base_extend(GF(7))                                                 # needs sage.rings.finite_rings
    ...
    def __mul__(self, x):
        ...
        EXAMPLES::
            ...
            sage: (x + y) * R                                                           # needs sage.rings.finite_rings
            Ideal (x + y) of Multivariate Polynomial Ring in x, y, z
             over Finite Field of size 7
            sage: (x + y, z + y^3) * R                                                  # needs sage.rings.finite_rings
    ...
    def _ideal_class_(self, n=0):
        ...
        EXAMPLES::
            ...
            sage: R._ideal_class_(1)                                                    # needs sage.rings.finite_rings
            <class 'sage.rings.polynomial.multi_polynomial_ideal.MPolynomialIdeal'>
            sage: S = R.quo(x^3 - y^2)                                                  # needs sage.rings.finite_rings
            sage: S._ideal_class_(1)                                                    # needs sage.rings.finite_rings
            <class 'sage.rings.quotient_ring.QuotientRingIdeal_principal'>
            sage: S._ideal_class_(2)                                                    # needs sage.rings.finite_rings
    ...
    def is_subring(self, other):
        ...
        EXAMPLES::
            ...
            True
            sage: ZZ.is_subring(GF(19))                                                 # needs sage.rings.finite_rings
            False
        ...
        TESTS::
            ...
            True
            sage: QQ.is_subring(GF(7))                                                  # needs sage.rings.finite_rings
            False
    ...
    def is_prime_field(self):
        ...
        EXAMPLES::
            ...
            True
            sage: GF(3).is_prime_field()                                                # needs sage.rings.finite_rings
            True
    ...
    def order(self):
        ...
        EXAMPLES::
            ...
            sage: GF(19).order()                                                        # needs sage.rings.finite_rings
            19
            sage: QQ.order()
            +Infinity
        """
    ...
    def zeta_order(self):
        ...
        EXAMPLES::
            ...
            38
            sage: GF(19).zeta_order()                                                   # needs sage.rings.finite_rings
            18
    ...
    def epsilon(self):
        ...
        For the symbolic ring, there is no reasonable answer::
            ...
            sage: SR.epsilon()                                                          # needs sage.symbolics
            Traceback (most recent call last):
            ...
            NotImplementedError
        """
...
cdef class CommutativeRing(Ring):
    ...
    def localization(self, additional_units, names=None, normalize=True, category=None):
        ...
        EXAMPLES::
            ...
            sage: R.<x, y> = GF(3)[]                                                    # needs sage.rings.finite_rings
    ...
    def frobenius_endomorphism(self, n=1):
        ...
        EXAMPLES::
            ...
            sage: Frob(u)                                                               # needs sage.rings.finite_rings
            u^5

        We can specify a power::

            sage: f = K.frobenius_endomorphism(2); f                                    # needs sage.rings.finite_rings
            Frobenius endomorphism x |--> x^(5^2) of Power Series Ring in u
             over Finite Field of size 5
            sage: f(1+u)                                                                # needs sage.rings.finite_rings
            1 + u^25
        """
...
cdef class IntegralDomain(CommutativeRing):
    ...
    def is_integrally_closed(self):
        ...
        EXAMPLES::
            ...
            True
            sage: GF(5).is_integrally_closed()                                          # needs sage.rings.finite_rings
            True
    ...
    def is_field(self, proof = True):
        ...
        EXAMPLES::
            ...
            sage: GF(7).is_field()                                                      # needs sage.rings.finite_rings
            True
...
cdef class Field(PrincipalIdealDomain):
    ...
    def _pseudo_fraction_field(self):
        ...
        EXAMPLES::
            ...
            sage: K._pseudo_fraction_field()                                            # needs sage.rings.finite_rings
            Finite Field of size 5
            sage: K._pseudo_fraction_field() is K                                       # needs sage.rings.finite_rings
            True
        """
        return self

...
def Ideal(*args, **kwds):
    ...
    even if they are PIDs.::
        ...
        sage: I = R * (x^2 + 3)                                                         # needs sage.rings.finite_rings
...
class Ideal_generic(MonoidElement):
    ...
    def random_element(self, *args, **kwds):
        ...
        EXAMPLES::
            ...
            sage: P.<a,b,c> = GF(5)[[]]                                                 # needs sage.rings.finite_rings
            sage: I = P.ideal([a^2, a*b + c, c^3])                                      # needs sage.rings.finite_rings
            sage: I.random_element()  # random                                          # needs sage.rings.finite_rings
    ...
    def __contains__(self, x):
        ...
        EXAMPLES::
            ...
            True
            sage: P2.<w,x,y,z> = QQ[]
            sage: x + 2*y + w*z in I                                                    # needs sage.libs.singular
            False
        """
        try:
    ...
    def is_maximal(self):
        ...
        EXAMPLES::
            ...
            sage: R = ZZ
            sage: I = R.ideal(7)
            sage: I.is_maximal()                                                        # needs sage.libs.pari
            True
            sage: R.ideal(16).is_maximal()                                              # needs sage.libs.pari
            False
            sage: S = Integers(8)
            sage: S.ideal(0).is_maximal()                                               # needs sage.libs.pari
            False
            sage: S.ideal(2).is_maximal()                                               # needs sage.libs.pari
            True
            sage: S.ideal(4).is_maximal()                                               # needs sage.libs.pari
            False
        """
    ...
    def is_primary(self, P=None):
        ...
        Some examples from the Macaulay2 documentation::
            ...
            True
            sage: I = R.ideal([x^4, y^7])                                               # needs sage.libs.singular
            sage: I.is_primary()                                                        # needs sage.libs.singular
            True
            sage: I = R.ideal([x*y, y^2])                                               # needs sage.libs.singular
            sage: I.is_primary()                                                        # needs sage.libs.singular
            False
    ...
    def is_prime(self):
        ...
        EXAMPLES::
            ...
            sage: S = Integers(8)
            sage: S.ideal(0).is_prime()                                                 # needs sage.libs.singular
            False
            sage: S.ideal(2).is_prime()                                                 # needs sage.libs.singular
            True
            sage: S.ideal(4).is_prime()                                                 # needs sage.libs.singular
            False
    ...
    def _macaulay2_init_(self, macaulay2=None):
        ...
        two variables in the finite field of size 2::
            ...
            sage: P.<x,y> = PolynomialRing(GF(2), 2)                                    # needs sage.rings.finite_rings
            sage: I = sage.rings.ideal.FieldIdeal(P); I                                 # needs sage.rings.finite_rings
...
class Ideal_pid(Ideal_principal):
    ...
    def is_prime(self):
        ...
        EXAMPLES::
            ...
            sage: ZZ.ideal(2).is_prime()                                                # needs sage.libs.pari
            True
            sage: ZZ.ideal(-2).is_prime()                                               # needs sage.libs.pari
            True
            sage: ZZ.ideal(4).is_prime()                                                # needs sage.libs.pari
            False
            sage: ZZ.ideal(0).is_prime()                                                # needs sage.libs.pari
            True
            sage: R.<x> = QQ[]
            sage: P = R.ideal(x^2 + 1); P                                               # needs sage.libs.pari
            Principal ideal (x^2 + 1) of Univariate Polynomial Ring in x over Rational Field
    ...
    def residue_field(self):
        ...
        TESTS::
            ...
            sage: ZZ.ideal(96).residue_field()                                          # needs sage.libs.pari
            Traceback (most recent call last):
            ...
        ...
        ::
            ...
            True
            sage: I.residue_field()                                                     # needs sage.libs.pari
            Traceback (most recent call last):
            ...

...
cdef class Parent(parent.Parent):
    ...
    TESTS::
        ...
        sage: V = VectorSpace(GF(2,'a'), 2)                                             # needs sage.modules sage.rings.finite_rings
        sage: V.list()                                                                  # needs sage.modules sage.rings.finite_rings
        [(0, 0), (1, 0), (0, 1), (1, 1)]
        sage: MatrixSpace(GF(3), 1, 1).list()                                           # needs sage.modules sage.rings.finite_rings
        [[0], [1], [2]]

...
cdef class Element(SageObject):
    ...
    def _mpmath_(self, prec=53, rounding=None):
        ...
        EXAMPLES::
            ...
            sage: 25._mpmath_(53)
            mpf('25.0')
            sage: mpmathify(3 + 4*I)                                                    # needs mpmath
            mpc(real='3.0', imag='4.0')
            sage: mpmathify(1 + pi)                                                     # needs mpmath
            mpf('4.14159265358979323846264338327933')
            sage: (1 + pi)._mpmath_(10)                                                 # needs mpmath
            mpf('4.140625')
            sage: (1 + pi)._mpmath_(mp.prec)                                            # needs mpmath
            mpf('4.14159265358979323846264338327933')
        """
...
cdef class RingElement(ModuleElement):
    ...
    def __divmod__(self, other):
        ...
        ::
            ...
            sage: divmod(x^2, x - 1)                                                    # needs sage.rings.finite_rings
            (x + 1, 1)
...
cdef class CommutativeRingElement(RingElement):
    ...
    def divides(self, x):
        ...
        :trac:`5347` has been fixed::
            ...
            sage: K(3).divides(1)                                                       # needs sage.rings.finite_rings
            True
            sage: K(3).divides(K(1))                                                    # needs sage.rings.finite_rings
            True
...
cdef class EuclideanDomainElement(PrincipalIdealDomainElement):
    ...
    cpdef _floordiv_(self, right):
        ...
        EXAMPLES::
            ...
            ....: ''')
            sage: e = MyElt(SR)                                                         # needs sage.misc.cython
            sage: e // e                                                                # needs sage.misc.cython
            quo
        """
...
def coercion_traceback(dump=True):
    ...
    EXAMPLES::
        ...
        sage: 1/5 + GF(5).gen()                                                         # needs sage.rings.finite_rings
        Traceback (most recent call last):
        ...
        TypeError: unsupported operand parent(s) for +:

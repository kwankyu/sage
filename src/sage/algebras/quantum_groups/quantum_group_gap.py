...
class QuaGroupRepresentationElement(QuaGroupModuleElement):
    ...
    def _vector_(self, R=None, order=None, sparse=False):
        ...
        EXAMPLES::
            ...
            sage: v._vector_(sparse=True)             # optional - gap_packages
            (1, 0, 0, 0, 0, 0, 0, 0)
            sage: x._vector_(sparse=True)             # optional - gap_packages
            (1, 1, 0, q^2, q, 0, 0, 0)

            sage: M = V.submodule([V.an_element()])   # optional - gap_packages

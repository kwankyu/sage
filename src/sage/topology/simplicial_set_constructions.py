...
EXAMPLES::
    ...
    sage: circle = K.quotient(endpoints)                                                # needs sage.graphs

The mapping cone of a morphism of simplicial sets is constructed as a
pushout::

    sage: eta = simplicial_sets.HopfMap()
    sage: CP2 = eta.mapping_cone()                                                      # needs sage.graphs
    sage: type(CP2)                                                                     # needs sage.graphs
...
twice returns the same result both times::
    ...
    sage: CP2.suspension() is CP2.suspension()                                          # needs sage.graphs
    True
...
will give you the same result each time::
    ...
    True
    sage: S2.disjoint_union(CP2, S2) == S2.disjoint_union(CP2, S2)                      # needs sage.graphs
    True
...
class SubSimplicialSet(SimplicialSet_finite, UniqueRepresentation):
    ...
    def __init__(self, data, ambient=None):
        ...
        EXAMPLES::
            ...
            sage: X = S3.disjoint_union(K)                                              # needs sage.graphs
            sage: Y = X.structure_map(0).image()  # the S3 summand                      # needs sage.graphs
            sage: Y.inclusion_map()                                                     # needs sage.graphs
            Simplicial set morphism:
              From: Simplicial set with 2 non-degenerate simplices
              To:   Disjoint union: (S^3 u Klein bottle)
              Defn: [v_0, sigma_3] --> [v_0, sigma_3]
            sage: Y.ambient_space()                                                     # needs sage.graphs
...
class Factors():
    ...
    def factor(self, i):
        ...
        EXAMPLES::
            ...
            sage: S2 = simplicial_sets.Sphere(2)
            sage: S3 = simplicial_sets.Sphere(3)
            sage: K = S2.disjoint_union(S3)                                             # needs sage.graphs
            sage: K.factor(0)                                                           # needs sage.graphs
            S^2
...
class PushoutOfSimplicialSets(SimplicialSet_arbitrary, UniqueRepresentation):
    ...
    def __init__(self, maps=None, vertex_name=None):
        ...
        EXAMPLES::
            ...
            sage: P = X.pushout(f0, f1)                                                 # needs sage.graphs
            sage: P.nondegenerate_simplices()                                           # needs sage.graphs
            [a, c, e_0, e_1]
        ...
        map `X \to CX`::
            ...
            sage: P = T.pushout(inc, inc)                                               # needs sage.graphs
            sage: P.homology()                                                          # needs sage.graphs sage.modules
            {0: 0, 1: 0, 2: Z x Z, 3: Z}
            sage: len(P.nondegenerate_simplices())                                      # needs sage.graphs
            20

        It is more efficient to construct the suspension as the
        quotient `CX/X`::

            sage: len(CT.quotient(CT.base_as_subset()).nondegenerate_simplices())       # needs sage.graphs
            8
        ...
        a base point::
            ...
            sage: T = simplicial_sets.Torus()
            sage: len(T.suspension().nondegenerate_simplices())                         # needs sage.graphs
            6

            sage: S1 = simplicial_sets.Sphere(1)
            sage: pt = simplicial_sets.Point()
            sage: bouquet = pt.pushout(S1.base_point_map(),                             # needs sage.graphs
            ....:                      S1.base_point_map(),
            ....:                      S1.base_point_map())
            sage: bouquet.homology(1)                                                   # needs sage.graphs sage.modules
            Z x Z x Z
        """
        # Import this here to prevent circular imports.
        from sage.topology.simplicial_set_morphism import SimplicialSetMorphism
    ...
    def defining_map(self, i):
        ...
        EXAMPLES::
            ...
            sage: S1 = simplicial_sets.Sphere(1)
            sage: T = simplicial_sets.Torus()
            sage: X = S1.wedge(T)  # a pushout                                          # needs sage.graphs
            sage: X.defining_map(0)                                                     # needs sage.graphs
            Simplicial set morphism:
              From: Point
              To:   S^1
              Defn: Constant map at v_0
            sage: X.defining_map(1).domain()                                            # needs sage.graphs
            Point
            sage: X.defining_map(1).codomain()                                          # needs sage.graphs
            Torus
        """
        return self._maps[i]
    ...
    def _repr_(self):
        ...
        EXAMPLES::
            ...
            sage: S3 = simplicial_sets.Sphere(3)
            sage: pt = simplicial_sets.Point()
            sage: pt.pushout(S2.base_point_map(), S3.base_point_map())                  # needs sage.graphs
            Pushout of maps:
              Simplicial set morphism:
                From: Point
                To:   S^2
...
class PushoutOfSimplicialSets_finite(PushoutOfSimplicialSets, SimplicialSet_finite):
    ...
    def __classcall_private__(cls, maps=None, vertex_name=None):
        ...
        TESTS::
            ...
            sage: S2 = simplicial_sets.Sphere(2)
            sage: one = S2.Hom(S2).identity()
            sage: PushoutOfSimplicialSets_finite([one, one]) == PushoutOfSimplicialSets_finite((one, one))              # needs sage.graphs
            True
        """
        if maps:
            return super().__classcall__(cls, maps=tuple(maps),
    ...
    def __init__(self, maps=None, vertex_name=None):
        ...
        EXAMPLES::
            ...
            sage: T = simplicial_sets.Torus()
            sage: S2 = simplicial_sets.Sphere(2)
            sage: PushoutOfSimplicialSets_finite([T.base_point_map(), S2.base_point_map()]).n_cells(0)[0]               # needs sage.graphs
            *
            sage: PushoutOfSimplicialSets_finite([T.base_point_map(), S2.base_point_map()], vertex_name='v').n_cells(0)[0]                                      # needs sage.graphs
            v
        """
    ...
    def structure_map(self, i):
        ...
        EXAMPLES::
            ...
            sage: S1 = simplicial_sets.Sphere(1)
            sage: T = simplicial_sets.Torus()
            sage: X = S1.disjoint_union(T)  # a pushout                                 # needs sage.graphs
            sage: X.structure_map(0)                                                    # needs sage.graphs
            Simplicial set morphism:
              From: S^1
              To:   Disjoint union: (S^1 u Torus)
              Defn: [v_0, sigma_1] --> [v_0, sigma_1]
            sage: X.structure_map(1).domain()                                           # needs sage.graphs
            Torus
            sage: X.structure_map(1).codomain()                                         # needs sage.graphs
...
class QuotientOfSimplicialSet(PushoutOfSimplicialSets):
    def __init__(self, inclusion, vertex_name='*'):
        ...
        EXAMPLES::
            ...
            sage: RP5_2 = RP5.quotient(RP2); RP5_2                                      # needs sage.graphs
            Quotient: (RP^5/Simplicial set with 3 non-degenerate simplices)
            sage: RP5_2.quotient_map()                                                  # needs sage.graphs
            Simplicial set morphism:
              From: RP^5
              To:   Quotient: (RP^5/Simplicial set with 3 non-degenerate simplices)
              Defn: [1, f, f * f, f * f * f, f * f * f * f, f * f * f * f * f]
    ...
    def ambient(self):
        ...
        EXAMPLES::
            ...
            sage: RP5 = simplicial_sets.RealProjectiveSpace(5)
            sage: RP2 = RP5.n_skeleton(2)
            sage: RP5_2 = RP5.quotient(RP2)                                             # needs sage.graphs
            sage: RP5_2.ambient()                                                       # needs sage.graphs
            RP^5
            ...
            sage: B = simplicial_sets.ClassifyingSpace(G)
            sage: K = B.n_skeleton(3)
            sage: Q = B.quotient(K)                                                     # needs sage.graphs
            sage: Q.ambient()                                                           # needs sage.graphs
            Classifying space of Multiplicative Abelian group isomorphic to C2
        """
    ...
    def subcomplex(self):
        ...
        EXAMPLES::
            ...
            sage: RP2 = RP5.n_skeleton(2)
            sage: RP5_2 = RP5.quotient(RP2)                                             # needs sage.graphs
            sage: RP5_2.subcomplex()                                                    # needs sage.graphs
            Simplicial set with 3 non-degenerate simplices
            ...
            sage: K = B.n_skeleton(3)
            sage: Q = B.quotient(K)                                                     # needs sage.graphs
            sage: Q.subcomplex()                                                        # needs sage.graphs
    ...
    def _repr_(self):
        ...
        EXAMPLES::
            ...
            sage: T = simplicial_sets.Torus()
            sage: T.quotient(T.n_skeleton(1))                                           # needs sage.graphs
    ...
    def _latex_(self):
        ...
        EXAMPLES::
            ...
            sage: latex(RPoo.quotient(RP3))                                             # needs sage.graphs
            RP^{\infty} / RP^{3}
        """
...
class QuotientOfSimplicialSet_finite(QuotientOfSimplicialSet,
    ...
    def quotient_map(self):
        ...
        EXAMPLES::
            ...
            sage: K = simplicial_sets.Simplex(1)
            sage: S1 = K.quotient(K.n_skeleton(0))                                      # needs sage.graphs
            sage: q = S1.quotient_map()                                                 # needs sage.graphs
            sage: q                                                                     # needs sage.graphs
            Simplicial set morphism:
              From: 1-simplex
              To:   Quotient: (1-simplex/Simplicial set with 2 non-degenerate simplices)
              Defn: [(0,), (1,), (0, 1)] --> [*, *, (0, 1)]
            sage: q.domain() == K                                                       # needs sage.graphs
            True
            sage: q.codomain() == S1                                                    # needs sage.graphs
            True
        """
...
class SmashProductOfSimplicialSets_finite(QuotientOfSimplicialSet_finite,
    ...
    def __classcall__(cls, factors=None):
        ...
        TESTS::
            ...
            sage: S2 = simplicial_sets.Sphere(2)
            sage: Smash([S2, S2]) == Smash((S2, S2))                                    # needs sage.graphs
            True
        """
        if factors:
            return super().__classcall__(cls, factors=tuple(factors))
    ...
    def __init__(self, factors=None):
        ...
        EXAMPLES::
            ...
            sage: T = simplicial_sets.Torus()
            sage: S2 = simplicial_sets.Sphere(2)
            sage: T.smash_product(S2).homology() == T.suspension(2).homology()          # needs sage.graphs sage.modules
            True
        """
    ...
    def _repr_(self):
        ...
        EXAMPLES::
            ...
            sage: S1.smash_product(RP4, S1)                                             # needs sage.graphs sage.groups
    ...
    def _latex_(self):
        ...
        EXAMPLES::
            ...
            sage: RP4 = simplicial_sets.RealProjectiveSpace(4)                          # needs sage.groups
            sage: S1 = simplicial_sets.Sphere(1)                                        # needs sage.groups
            sage: latex(S1.smash_product(RP4, S1))                                      # needs sage.graphs sage.groups
...
class WedgeOfSimplicialSets(PushoutOfSimplicialSets, Factors):
    ...
    def __classcall__(cls, factors=None):
        ...
        TESTS::
            ...
            sage: S2 = simplicial_sets.Sphere(2)
            sage: WedgeOfSimplicialSets([S2, S2]) == WedgeOfSimplicialSets((S2, S2))    # needs sage.graphs
            True
        """
        if factors:
            return super().__classcall__(cls, factors=tuple(factors))
    ...
    def __init__(self, factors=None):
        ...
        EXAMPLES::
            ...
            sage: K = simplicial_sets.KleinBottle()
            sage: W = CP2.wedge(K)                                                      # needs sage.graphs
            sage: W.homology()                                                          # needs sage.graphs sage.modules
            {0: 0, 1: Z x C2, 2: Z, 3: 0, 4: Z}

            sage: W.inclusion_map(1)                                                    # needs sage.graphs
            Simplicial set morphism:
              From: Klein bottle
            ...
            sage: W.projection_map(0).domain()                                          # needs sage.graphs
            Wedge: (CP^2 v Klein bottle)
            sage: W.projection_map(0).codomain() # copy of CP^2                         # needs sage.graphs
            Quotient: (Wedge: (CP^2 v Klein bottle)/Simplicial set with 6 non-degenerate simplices)
            sage: W.projection_map(0).codomain().homology()                             # needs sage.graphs sage.modules
            {0: 0, 1: 0, 2: Z, 3: 0, 4: Z}

        An error occurs if any of the factors is not pointed::

            sage: CP2.wedge(simplicial_sets.Simplex(1))                                 # needs sage.graphs
    ...
    def _repr_(self):
        ...
        EXAMPLES::
            ...
            sage: K = simplicial_sets.KleinBottle()
            sage: K.wedge(K, K)                                                         # needs sage.graphs
    ...
    def _latex_(self):
        ...
        EXAMPLES::
            ...
            sage: RP4 = simplicial_sets.RealProjectiveSpace(4)                          # needs sage.groups
            sage: S1 = simplicial_sets.Sphere(1)                                        # needs sage.groups
            sage: latex(S1.wedge(RP4, S1))                                              # needs sage.graphs sage.groups
...
class WedgeOfSimplicialSets_finite(WedgeOfSimplicialSets, PushoutOfSimplicialSets_finite):
    ...
    def __init__(self, factors=None):
        ...
        EXAMPLES::
            ...
            sage: WedgeOfSimplicialSets_finite((K,K))                                   # needs sage.graphs
            Traceback (most recent call last):
            ...
            ValueError: the simplicial sets must be pointed
        """
    ...
    def inclusion_map(self, i):
        ...
        EXAMPLES::
            ...
            sage: S1 = simplicial_sets.Sphere(1)
            sage: S2 = simplicial_sets.Sphere(2)
            sage: W = S1.wedge(S2, S1)                                                  # needs sage.graphs
            sage: W.inclusion_map(1)                                                    # needs sage.graphs
            Simplicial set morphism:
              From: S^2
              To:   Wedge: (S^1 v S^2 v S^1)
              Defn: [v_0, sigma_2] --> [*, sigma_2]
            sage: W.inclusion_map(0).domain()                                           # needs sage.graphs
            S^1
            sage: W.inclusion_map(2).domain()                                           # needs sage.graphs
            S^1
        """
        return self.structure_map(i)
    ...
    def projection_map(self, i):
        ...
        EXAMPLES::
            ...
            sage: S2 = simplicial_sets.Sphere(2)
            sage: W = S1.wedge(S2, S1)                                                  # needs sage.graphs
            sage: W.projection_map(1)                                                   # needs sage.graphs
            Simplicial set morphism:
            ...
            sage: W.projection_map(1).image().homology(1)                               # needs sage.graphs sage.modules
            0
            sage: W.projection_map(1).image().homology(2)                               # needs sage.graphs sage.modules
            Z
        """
        m = len(self._factors)
...
class DisjointUnionOfSimplicialSets(PushoutOfSimplicialSets, Factors):
    ...
    def __init__(self, factors=None):
        ...
        EXAMPLES::
            ...
            sage: CP2 = simplicial_sets.ComplexProjectiveSpace(2)
            sage: K = simplicial_sets.KleinBottle()
            sage: W = CP2.disjoint_union(K)                                             # needs sage.graphs
            sage: W.homology()                                                          # needs sage.graphs sage.modules
    ...
    def _latex_(self):
        ...
        EXAMPLES::
            ...
            sage: RP4 = simplicial_sets.RealProjectiveSpace(4)                          # needs sage.groups
            sage: S1 = simplicial_sets.Sphere(1)
            sage: latex(S1.disjoint_union(RP4, S1))                                     # needs sage.graphs sage.groups
...
class DisjointUnionOfSimplicialSets_finite(DisjointUnionOfSimplicialSets,
    ...
    def __init__(self, factors=None):
        ...
        EXAMPLES::
            ...
            sage: DisjointUnionOfSimplicialSets_finite((S,S,S))                         # needs sage.graphs
            Disjoint union: (S^4 u S^4 u S^4)
            sage: DisjointUnionOfSimplicialSets_finite([Empty(), Empty()]) == Empty()   # needs sage.graphs
            True
        """
        if not factors:
    ...
    def inclusion_map(self, i):
        ...
        EXAMPLES::
            ...
            sage: S1 = simplicial_sets.Sphere(1)
            sage: S2 = simplicial_sets.Sphere(2)
            sage: W = S1.disjoint_union(S2, S1)                                         # needs sage.graphs
            sage: W.inclusion_map(1)                                                    # needs sage.graphs
            Simplicial set morphism:
              From: S^2
...
class ConeOfSimplicialSet(SimplicialSet_arbitrary, UniqueRepresentation):
    ...
    def n_skeleton(self, n):
        ...
        EXAMPLES::
            ...
            sage: G = groups.misc.MultiplicativeAbelian([2])
            sage: B = simplicial_sets.ClassifyingSpace(G)
            sage: X = B.disjoint_union(B)                                               # needs sage.graphs
            sage: CX = B.cone()                                                         # needs sage.graphs
            sage: CX.n_skeleton(3).homology()                                           # needs sage.graphs sage.modules
            {0: 0, 1: 0, 2: 0, 3: Z}
        """
        if self.is_finite():
    ...
    def _repr_(self):
        ...
        EXAMPLES::
            ...
            sage: simplicial_sets.Simplex(3).cone()                                     # needs sage.graphs
            Cone of 3-simplex
        """
    ...
    def _latex_(self):
        ...
        EXAMPLES::
            ...
            sage: latex(simplicial_sets.Simplex(3).cone())                              # needs sage.graphs
            C \Delta^{3}
        """
...
class ConeOfSimplicialSet_finite(ConeOfSimplicialSet, SimplicialSet_finite):
    ...
    def base_as_subset(self):
        ...
        EXAMPLES::
            ...
            sage: Y = X.cone()                                                          # needs sage.graphs
            sage: Y.base_as_subset()                                                    # needs sage.graphs
            Simplicial set with 5 non-degenerate simplices
            sage: Y.base_as_subset() == X                                               # needs sage.graphs
            True
        """
        X = self._base
    ...
    def map_from_base(self):
        ...
        EXAMPLES::
            ...
            sage: Y = X.cone()                                                          # needs sage.graphs
            sage: Y.map_from_base()                                                     # needs sage.graphs
            Simplicial set morphism:
...
class ReducedConeOfSimplicialSet(QuotientOfSimplicialSet):
    def __init__(self, base):
        ...
        EXAMPLES::
            ...
            sage: X = SimplicialSet({e: (v, v)})
            sage: X = X.set_base_point(v)
            sage: CX = X.cone()  # indirect doctest                                     # needs sage.graphs
            sage: CX.nondegenerate_simplices()                                          # needs sage.graphs
            [*, e, (e,*)]
        """
    ...
    def n_skeleton(self, n):
        ...
        EXAMPLES::
            ...
            sage: G = groups.misc.MultiplicativeAbelian([2])                            # needs sage.groups
            sage: B = simplicial_sets.ClassifyingSpace(G)                               # needs sage.groups
            sage: B.cone().n_skeleton(3).homology()                                     # needs sage.graphs sage.groups sage.modules
            {0: 0, 1: 0, 2: 0, 3: Z}
        """
        if self.is_finite():
            return SimplicialSet_finite.n_skeleton(self, n)
    ...
    def _latex_(self):
        ...
        EXAMPLES::
            ...
            sage: latex(simplicial_sets.Sphere(4).cone())                               # needs sage.graphs
            C S^{4}
        """
        return 'C {}'.format(latex(self._base))
...
class ReducedConeOfSimplicialSet_finite(ReducedConeOfSimplicialSet,
    ...
    def map_from_base(self):
        ...
        EXAMPLES::
            ...
            sage: S3 = simplicial_sets.Sphere(3)
            sage: CS3 = S3.cone()                                                       # needs sage.graphs
            sage: CS3.map_from_base()                                                   # needs sage.graphs
            Simplicial set morphism:
              From: S^3
...
class SuspensionOfSimplicialSet(SimplicialSet_arbitrary, UniqueRepresentation):
    def __init__(self, base):
        ...
        EXAMPLES::
            ...
            sage: G = groups.misc.MultiplicativeAbelian([2])
            sage: B = simplicial_sets.ClassifyingSpace(G)
            sage: B.suspension()                                                        # needs sage.graphs
            Sigma(Classifying space of Multiplicative Abelian group isomorphic to C2)
            sage: B.suspension().n_skeleton(3).homology()                               # needs sage.graphs sage.modules
            {0: 0, 1: 0, 2: C2, 3: 0}
        ...
        from the cone::
            ...
            sage: S3 = simplicial_sets.Sphere(3)
            sage: S4 = S3.suspension()                                                  # needs sage.graphs
            sage: S4.quotient_map()                                                     # needs sage.graphs
            Simplicial set morphism:
        ...
        TESTS::
            ...
            sage: S3.suspension() == S3.suspension()                                    # needs sage.graphs
            True
            sage: S3.suspension() == simplicial_sets.Sphere(3).suspension()             # needs sage.graphs
            False
            sage: B.suspension() == B.suspension()                                      # needs sage.graphs sage.groups
            True
        """
        Cat = SimplicialSets()
        if base.is_finite():
    ...
    def n_skeleton(self, n):
        ...
        EXAMPLES::
            ...
            sage: G = groups.misc.MultiplicativeAbelian([2])
            sage: B = simplicial_sets.ClassifyingSpace(G)
            sage: SigmaB = B.suspension()                                               # needs sage.graphs
            sage: SigmaB.n_skeleton(4).homology(base_ring=GF(2))                        # needs sage.graphs sage.modules sage.rings.finite_rings
            {0: Vector space of dimension 0 over Finite Field of size 2,
    ...
    def __repr_or_latex__(self, output_type=None):
        ...
        EXAMPLES::
            ...
            sage: T = simplicial_sets.Torus()
            sage: K = T.suspension(10)                                                  # needs sage.graphs
            sage: K.__repr_or_latex__()                                                 # needs sage.graphs
            'Sigma^10(Torus)'
            sage: K.__repr_or_latex__('latex')                                          # needs sage.graphs
    ...
    def _repr_(self):
        ...
        EXAMPLES::
            ...
            sage: S2 = simplicial_sets.Sphere(2)
            sage: S2.suspension(3)                                                      # needs sage.graphs
            Sigma^3(S^2)
            sage: K = simplicial_sets.Simplex(2)
            sage: K.suspension(3)                                                       # needs sage.graphs
            S^3(2-simplex)
            sage: K.suspension()                                                        # needs sage.graphs
            S(2-simplex)
        """
    ...
    def _latex_(self):
        ...
        EXAMPLES::
            ...
            sage: S2 = simplicial_sets.Sphere(2)
            sage: latex(S2.suspension(3))                                               # needs sage.graphs
            \Sigma^{3}(S^{2})
            sage: K = simplicial_sets.Simplex(2)
            sage: latex(K.suspension(3))                                                # needs sage.graphs
            S^{3}(\Delta^{2})
            sage: latex(K.suspension())                                                 # needs sage.graphs
            S(\Delta^{2})
        """
...
class SuspensionOfSimplicialSet_finite(SuspensionOfSimplicialSet,
    ...
    def __init__(self, base):
        ...
        EXAMPLES::
            ...
            sage: X.suspension(2)                                                       # needs sage.graphs
            Sigma^2(S^3)
            sage: Y = X.unset_base_point()
            sage: Y.suspension(2)                                                       # needs sage.graphs

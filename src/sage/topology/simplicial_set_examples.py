...
def ComplexProjectiveSpace(n):
    ...
    EXAMPLES::
        ...
        {0: Z, 1: 0, 2: Z, 3: 0, 4: Z}
        sage: CP3 = simplicial_sets.ComplexProjectiveSpace(3)                           # needs pyparsing
        sage: CP3                                                                       # needs pyparsing
        CP^3
...
def HopfMap():
    ...
    Using the Hopf map to attach a cell::
        ...
        sage: X = g.mapping_cone()                                                      # needs sage.graphs
        sage: CP2 = simplicial_sets.ComplexProjectiveSpace(2)                           # needs sage.graphs
        sage: X.homology() == CP2.homology()                                            # needs sage.graphs
        True

        sage: X.f_vector()                                                              # needs sage.graphs
        [1, 0, 5, 9, 6]
        sage: CP2.f_vector()                                                            # needs sage.graphs
        [1, 0, 2, 3, 3]
    """

    ...
    class MorphismMethods:
        ...
        def is_injective(self) -> bool:
            ...
            characteristic can not be injective::
                ...
                sage: R.<x> = ZZ[]
                sage: f = R.hom([GF(3)(1)]); f                                          # needs sage.rings.finite_rings
                Ring morphism:
            ...
            A coercion to the fraction field is injective::
                ...
                sage: R.fraction_field().coerce_map_from(R).is_injective()              # needs sage.rings.padics
                True
        ...
        def extend_to_fraction_field(self):
            ...
            field and an error is raised::
                ...
                sage: f = GF(5).coerce_map_from(ZZ)                                     # needs sage.rings.finite_rings
                sage: f.extend_to_fraction_field()                                      # needs sage.rings.finite_rings
    ...
    class ParentMethods:
        ...
        def is_zero(self) -> bool:
            ...
            EXAMPLES::
                ...
                sage: R.quo(77).is_zero()                                               # needs sage.rings.finite_rings
                True
        ...
        def characteristic(self):
            ...
            EXAMPLES::
                ...
                0
                sage: GF(19).characteristic()                                           # needs sage.rings.finite_rings
                19
        ...
        def quotient(self, I, names=None, **kwds):
            ...
            category framework::
                ...
                sage: from sage.rings.noncommutative_ideals import Ideal_nc             # needs sage.combinat sage.modules
                sage: from itertools import product
                sage: class PowerIdeal(Ideal_nc):                                       # needs sage.combinat sage.modules
                ...
                sage: I = PowerIdeal(F, 3)                                              # needs sage.combinat sage.modules
                sage: Q = Rings().parent_class.quotient(F, I); Q                        # needs sage.combinat sage.modules
                ...
                sage: Q.0                                                               # needs sage.combinat sage.modules
                xbar
                sage: Q.1                                                               # needs sage.combinat sage.modules
                ybar
                sage: Q.2                                                               # needs sage.combinat sage.modules
                zbar
                sage: Q.0*Q.1                                                           # needs sage.combinat sage.modules
                xbar*ybar
                sage: Q.0*Q.1*Q.0                                                       # needs sage.combinat sage.modules
                0
            ...
            An example with polynomial rings::
                ...
                sage: S                                                                 # needs sage.libs.singular
        ...
        def __getitem__(self, arg):
            ...
            We create several polynomial rings::
                ...
                sage: GF(17)['abc']                                                     # needs sage.rings.finite_rings
                Univariate Polynomial Ring in abc over Finite Field of size 17
                sage: GF(17)['a,b,c']                                                   # needs sage.rings.finite_rings
                Multivariate Polynomial Ring in a, b, c over Finite Field of size 17
                sage: GF(17)['a']['b']                                                  # needs sage.rings.finite_rings

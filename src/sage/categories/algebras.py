    ...
    class ElementMethods:
        ...
        def _div_(self, y):
            ...
            EXAMPLES::
                ...
                sage: C = AlgebrasWithBasis(QQ).example()                               # needs sage.combinat
                sage: x = C(2); x                                                       # needs sage.combinat
                2*B[word: ]
                sage: y = C.algebra_generators().first(); y                             # needs sage.combinat
                B[word: a]

                sage: y._div_(x)                                                        # needs sage.combinat
                1/2*B[word: a]
                sage: x._div_(y)                                                        # needs sage.combinat

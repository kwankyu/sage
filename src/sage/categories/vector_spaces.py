    ...
    class ParentMethods:
        ...
        def dimension(self):
            ...
            EXAMPLES::
                ...
                sage: M = FreeModule(FiniteField(19), 100)                              # needs sage.modules sage.rings.finite_rings
                sage: W = M.submodule([M.gen(50)])                                      # needs sage.modules sage.rings.finite_rings
                sage: W.dimension()                                                     # needs sage.modules sage.rings.finite_rings
                1

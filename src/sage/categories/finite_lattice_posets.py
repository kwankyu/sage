    ...
    class ParentMethods:
        ...
        def join_irreducibles(self):
            ...
            EXAMPLES::
                ...
                sage: L = LatticePoset({0:[1,2],1:[3],2:[3,4],3:[5],4:[5]})             # needs sage.combinat sage.graphs
                sage: L.join_irreducibles()                                             # needs sage.combinat sage.graphs
                [1, 2, 4]
        ...
        def join_irreducibles_poset(self):
            ...
            EXAMPLES::
                ...
                sage: L = LatticePoset({0:[1,2,3],1:[4],2:[4],3:[4]})                   # needs sage.combinat sage.graphs
                sage: L.join_irreducibles_poset()                                       # needs sage.combinat sage.graphs
        ...
        def meet_irreducibles(self):
            ...
            EXAMPLES::
                ...
                sage: L = LatticePoset({0:[1,2],1:[3],2:[3,4],3:[5],4:[5]})             # needs sage.combinat sage.graphs
                sage: L.meet_irreducibles()                                             # needs sage.combinat sage.graphs
                [1, 3, 4]
        ...
        def irreducibles_poset(self):
            ...
            TESTS::
                ...
                sage: LatticePoset().irreducibles_poset()                               # needs sage.combinat sage.graphs
                Finite poset containing 0 elements
                sage: posets.ChainPoset(1).irreducibles_poset()                         # needs sage.combinat sage.graphs
        ...
        def is_lattice_morphism(self, f, codomain):
            ...
            We construct the boolean lattice `B_2`::
                ...
                sage: B = posets.BooleanLattice(2)                                      # needs sage.combinat sage.graphs
                sage: B.cover_relations()                                               # needs sage.combinat sage.graphs
                [[0, 1], [0, 2], [1, 3], [2, 3]]
            ...
            numbered respectively `-1` and `3`::
                ...
                sage: L = LatticePoset(G)                                               # needs sage.combinat sage.graphs
                sage: L.cover_relations()                                               # needs sage.combinat sage.graphs
                [[-1, 0], [0, 1], [0, 2], [1, 3], [2, 3], [3, 4]]

                sage: f = {B(0): L(0), B(1): L(1), B(2): L(2), B(3): L(3)}.__getitem__  # needs sage.combinat sage.graphs
                sage: B.is_lattice_morphism(f, L)                                       # needs sage.combinat sage.graphs
                True

                sage: f = {B(0): L(-1),B(1): L(1), B(2): L(2), B(3): L(3)}.__getitem__  # needs sage.combinat sage.graphs
                sage: B.is_lattice_morphism(f, L)                                       # needs sage.combinat sage.graphs
                False

                sage: f = {B(0): L(0), B(1): L(1), B(2): L(2), B(3): L(4)}.__getitem__  # needs sage.combinat sage.graphs
                sage: B.is_lattice_morphism(f, L)                                       # needs sage.combinat sage.graphs
                False

    ...
    class ParentMethods:
        ...
        def _test_antipode(self, **options):
            ...
            TESTS::
                ...
                sage: R = NonCommutativeSymmetricFunctions(QQ).ribbon()                 # needs sage.combinat
                sage: R._test_antipode()                                                # needs sage.combinat

            ::

                sage: s = SymmetricFunctions(QQ).schur()                                # needs sage.combinat
                sage: s._test_antipode()                                                # needs sage.combinat

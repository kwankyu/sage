    ...
    class ParentMethods:
        ...
        def meet(self, x, y):
            ...
            EXAMPLES::
                ...
                sage: D = LatticePoset((divisors(30), attrcall("divides")))             # needs sage.combinat
                sage: D.meet( D(6), D(15) )                                             # needs sage.combinat
                3
            """
        ...
        def join(self, x, y):
            ...
            EXAMPLES::
                ...
                sage: D = LatticePoset((divisors(60), attrcall("divides")))             # needs sage.combinat
                sage: D.join( D(6), D(10) )                                             # needs sage.combinat
                30
            """

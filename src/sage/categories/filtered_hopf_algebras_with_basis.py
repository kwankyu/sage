        ...
        class ParentMethods:
            ...
            def antipode(self, elem):
                ...
                TESTS::
                    ...
                    sage: H = GradedHopfAlgebrasWithBasis(QQ).Connected().example()     # needs sage.combinat
                    sage: H.antipode(H.monomial(14))                                    # needs sage.combinat
                    P14

                    sage: H.monomial(0).antipode()                                      # needs sage.combinat
                    P0
                    sage: H.monomial(2).antipode()                                      # needs sage.combinat
                    P2
                    sage: (2*H.monomial(1) + 3*H.monomial(4)).antipode()                # needs sage.combinat
                    -2*P1 + 3*P4
                """

        ...
        class ParentMethods:
            ...
            def base_point_map(self, domain=None):
                ...
                EXAMPLES::
                    ...
                    sage: temp = simplicial_sets.Simplex(0)                             # needs sage.groups
                    sage: pt = temp.set_base_point(temp.n_cells(0)[0])                  # needs sage.groups
            ...
            def is_simply_connected(self):
                ...
                EXAMPLES::
                    ...
                    sage: X.is_simply_connected()                                       # needs sage.groups
                    False
            ...
            def connectivity(self, max_dim=None):
                ...
                EXAMPLES::
                    ...
                    2
                    sage: simplicial_sets.Sphere(0).connectivity()                      # needs sage.groups
                    -1

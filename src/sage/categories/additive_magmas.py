        ...
        class ParentMethods:
            ...
            def is_empty(self):
                ...
                EXAMPLES::
                    ...
                    sage: A = AdditiveAbelianGroup([3, 3])                              # needs sage.groups
                    sage: A in AdditiveMagmas()                                         # needs sage.groups
                    True
                    sage: A.is_empty()                                                  # needs sage.groups
                    False
                ...
                category in both examples above::
                    ...
                    sage: A.is_empty.__module__                                         # needs sage.groups
                    'sage.categories.additive_magmas'
        ...
        class ElementMethods:
            ...
            def _sub_(left, right):
                ...
                Check that :trac:`18275` is fixed::
                    ...
                    sage: C = GF(5).cartesian_product(GF(5))                            # needs sage.rings.finite_rings
                    sage: C.one() - C.one()                                             # needs sage.rings.finite_rings
                    (0, 0)
                """
                return left + (-right)
                ...
                class ElementMethods:
                    def _neg_(self):
                        ...
                        EXAMPLES::
                           ...
                           sage: x = cartesian_product((GF(7)(2), 17)); x               # needs sage.rings.finite_rings
                           (2, 17)
                        ...
                        TESTS::
                           ...
                           sage: C = AdditiveMagmas().AdditiveUnital().AdditiveInverse().CartesianProducts()
                           sage: x.parent() in C                                        # needs sage.rings.finite_rings
                           True
                        """
                        return self.parent()._cartesian_product_of_elements(
            ...
            class ParentMethods:
                ...
                def zero(self):
                    ...
                    EXAMPLES::
                        ...
                        sage: A = Sets().WithRealizations().example(); A                # needs sage.combinat
                        The subset algebra of {1, 2, 3} over Rational Field
                        sage: A.zero.__module__                                         # needs sage.combinat
                        'sage.categories.additive_magmas'
                        sage: A.zero()                                                  # needs sage.combinat
                        0

                    TESTS::

                        sage: A.zero() is A.a_realization().zero()                      # needs sage.combinat
                        True
                        sage: A._test_zero()                                            # needs sage.combinat
                    """

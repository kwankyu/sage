...
class CommutativeRings(CategoryWithAxiom):
    ...
    class ParentMethods:
        ...
        def over(self, base=None, gen=None, gens=None, name=None, names=None):
            ...
            We construct an extension of finite fields::
                ...
                sage: k = GF(5^4)                                                       # needs sage.rings.finite_rings
                sage: z4 = k.gen()                                                      # needs sage.rings.finite_rings

                sage: K = k.over(F)                                                     # needs sage.rings.finite_rings
                sage: K                                                                 # needs sage.rings.finite_rings
            ...
            (here k) is used and the same name is kept::
                ...
                sage: K.gen()                                                           # needs sage.rings.finite_rings
                z4
                sage: K(z4)                                                             # needs sage.rings.finite_rings
                z4
            ...
            Note that the shortcut ``K.<a>`` is also available::
                ...
                sage: KKa.<a> = k.over(F)                                               # needs sage.rings.finite_rings
                sage: KKa is Ka                                                         # needs sage.rings.finite_rings
                True
            ...
            Building an extension on top of another extension is allowed::
                ...
                sage: L.base_ring()                                                     # needs sage.rings.finite_rings
                Field in z4 with defining polynomial
                 x^2 + (4*z2 + 3)*x + z2 over its base
            ...
            When ``base`` is omitted, the canonical base of the ring is used::
                ...
                sage: S.<x> = QQ[]
                sage: E = S.over()                                                      # needs sage.modules
                sage: E                                                                 # needs sage.modules
    ...
    class Finite(CategoryWithAxiom):
        ...
        EXAMPLES::
            ...
            sage: cartesian_product([Zmod(34),                                          # needs sage.rings.finite_rings
        ...
        class ParentMethods:
            def cyclotomic_cosets(self, q, cosets=None):
                ...
                We compute some examples of minimal polynomials::
                    ...
                    X^3 + X^2 + 2*X + 1
                    sage: cyc7 = Zmod(26).cyclotomic_cosets(3, cosets=[7]); cyc7        # needs sage.rings.finite_rings
                    [[7, 11, 21]]
                ...
                ring::
                    ...
                    sage: R = cartesian_product([GF(7), Zmod(14)])                      # needs sage.rings.finite_rings
                    sage: a = R((3,5))                                                  # needs sage.rings.finite_rings
                    sage: R.cyclotomic_cosets((3,5), [(1,1)])                           # needs sage.rings.finite_rings
    ...
    class CartesianProducts(CartesianProductsCategory):
        def extra_super_categories(self):
            ...
            EXAMPLES::
                ...
                [Category of commutative rings]
                sage: cartesian_product([ZZ, Zmod(34),                                  # needs sage.rings.finite_rings

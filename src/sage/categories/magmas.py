            ...
            class ElementMethods:
                def __invert__(self):
                    ...
                    EXAMPLES::
                        ...
                        sage: C = cartesian_product([QQ, ZZ, RR, GF(5)])                # needs sage.rings.finite_rings
                        sage: c = C([2,-1,2,2]); c                                      # needs sage.rings.finite_rings
                    ...
                    invertible::
                        ...
                        sage: ~C([0,2,2,2])                                             # needs sage.rings.finite_rings
                        Traceback (most recent call last):
                        ...
                        ZeroDivisionError: rational division by zero

                        sage: ~C([2,2,2,2])                                             # needs sage.rings.finite_rings

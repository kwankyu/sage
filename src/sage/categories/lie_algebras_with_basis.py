...
class LieAlgebrasWithBasis(CategoryWithAxiom_over_base_ring):
    ...
    def example(self, gens=None):
        ...
        EXAMPLES::
            ...
            sage: LieAlgebras(QQ).WithBasis().example()                                 # needs sage.combinat
        ...
        Another set of generators can be specified as an optional argument::
            ...
            sage: LieAlgebras(QQ).WithBasis().example(Compositions())                   # needs sage.combinat
            An example of a Lie algebra: the abelian Lie algebra on the
    ...
    class ParentMethods:
        def _basis_key(self, x):
            ...
            TESTS::
                ...
                sage: L = LieAlgebras(QQ).WithBasis().example()                         # needs sage.combinat
                sage: L._basis_key(Partition([3,1]))                                    # needs sage.combinat
                [3, 1]
            """
            return x
        ...
        def bracket_on_basis(self, x, y):
            ...
            EXAMPLES::
                ...
                sage: L = LieAlgebras(QQ).WithBasis().example()                         # needs sage.combinat
                sage: L.bracket_on_basis(Partition([3,1]), Partition([2,2,1,1]))        # needs sage.combinat
                0
            """
        ...
        def module(self):
            ...
            EXAMPLES::
                ...
                sage: L = LieAlgebras(QQ).WithBasis().example()                         # needs sage.combinat
                sage: L.module()                                                        # needs sage.combinat
        ...
        def from_vector(self, v, order=None, coerce=False):
            ...
            EXAMPLES::
                ...
                sage: L = LieAlgebras(QQ).FiniteDimensional().WithBasis().example()     # needs sage.combinat
                sage: u = L.from_vector(vector(QQ, (1, 0, 0))); u                       # needs sage.combinat
                (1, 0, 0)
                sage: parent(u) is L                                                    # needs sage.combinat
                True
            """
            B = self.basis()
        ...
        def dimension(self):
            ...
            EXAMPLES::
                ...
                sage: L = LieAlgebras(QQ).FiniteDimensional().WithBasis().example()     # needs sage.combinat
                sage: L.dimension()                                                     # needs sage.combinat
                3

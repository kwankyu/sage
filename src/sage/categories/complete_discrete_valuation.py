    ...
    class ElementMethods:
        ...
        def denominator(self):
            ...
            EXAMPLES::
                ...
                sage: x = K(1/21)                                                       # needs sage.rings.padics
                sage: x.denominator()                                                   # needs sage.rings.padics
                7 + O(7^21)

                sage: x = K(7)                                                          # needs sage.rings.padics
                sage: x.denominator()                                                   # needs sage.rings.padics
                1 + O(7^20)
        ...
        def numerator(self):
            ...
            EXAMPLES::
                ...
                sage: K = Qp(7, 5)                                                      # needs sage.rings.padics
                sage: x = K(1/21)                                                       # needs sage.rings.padics
                sage: x.numerator()                                                     # needs sage.rings.padics
                5 + 4*7 + 4*7^2 + 4*7^3 + 4*7^4 + O(7^5)

                sage: x == x.numerator() / x.denominator()                              # needs sage.rings.padics
                True

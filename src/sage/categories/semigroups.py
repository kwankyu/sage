    ...
    class ParentMethods:
        ...
        def cayley_graph(self, side="right", simple=False, elements=None,
            ...
            the elements of length at most 3::
                ...
                sage: elements = [M.prod(w)                                             # needs sage.combinat
                ....:             for w in sum((list(Words(M.semigroup_generators(), k))
                ....:                           for k in range(4)), [])]
                sage: G = M.cayley_graph(elements=elements)                             # needs sage.combinat sage.graphs
                sage: G.num_verts(), G.num_edges()                                      # needs sage.combinat sage.graphs
                (85, 84)
                sage: G.show3d(color_by_label=True, edge_size=0.001, vertex_size=0.01)  # needs sage.combinat sage.graphs sage.plot
        ...
        def subsemigroup(self, generators, one=None, category=None):
            ...
            EXAMPLES::
                ...
                sage: M = R.subsemigroup([R(3), R(5)]); M                               # needs sage.groups
            ...
            By default, `M` is just in the category of subsemigroups::
                ...
                sage: M in Semigroups().Subobjects()                                    # needs sage.groups
                True
            ...
            subsemigroup, and we need to specify its unit explicitly::
                ...
                sage: M = R.subsemigroup([R(5)],                                        # needs sage.groups
            ...
            TESTS::
                ...
                sage: TestSuite(M).run()                                                # needs sage.groups

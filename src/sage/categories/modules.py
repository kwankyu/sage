    ...
    class SubcategoryMethods:
        ...
        def base_ring(self):
            ...
            EXAMPLES::
                ...
                sage: C = DescentAlgebra(QQ,3).B().category()                           # needs sage.combinat sage.modules
                sage: C.base_ring.__module__                                            # needs sage.combinat sage.modules
                'sage.categories.modules'
                sage: C.base_ring()                                                     # needs sage.combinat sage.modules
                Rational Field

                sage: C = QuasiSymmetricFunctions(QQ).F().category()                    # needs sage.combinat sage.modules
                sage: C.base_ring.__module__                                            # needs sage.combinat sage.modules
                'sage.categories.modules'
                sage: C.base_ring()                                                     # needs sage.combinat sage.modules
                Rational Field
    ...
    class FiniteDimensional(CategoryWithAxiom_over_base_ring):
        ...
        def extra_super_categories(self):
            ...
            EXAMPLES::
                ...
                []
                sage: Modules(GF(5)).FiniteDimensional().is_subcategory(Sets().Finite())            # needs sage.rings.finite_rings
                True
    ...
    class ParentMethods:
        ...
        def quotient(self, submodule, check=True, **kwds):
            ...
            EXAMPLES::
                ...
                sage: TA = TensorAlgebra(C)                                             # needs sage.modules
                sage: TA.quotient                                                       # needs sage.modules

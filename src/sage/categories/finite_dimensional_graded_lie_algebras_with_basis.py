    ...
    class ParentMethods:
        def _test_grading(self, **options):
            ...
            EXAMPLES::
                ...
                sage: L._test_grading()                                                 # needs sage.combinat sage.modules
                sage: L = LieAlgebra(QQ, {('x','y'): {'x': 1}},                         # needs sage.combinat sage.modules
                ....:                nilpotent=True, category=C)
                sage: L._test_grading()                                                 # needs sage.combinat sage.modules
        ...
        class ParentMethods:
            ...
            def degree_on_basis(self, m):
                ...
                EXAMPLES::
                    ...
                    sage: sc = {('X','Y'): {'Z': 1}}
                    sage: L.<X,Y,Z> = LieAlgebra(QQ, sc, nilpotent=True, category=C)    # needs sage.combinat sage.modules
                    sage: L.degree_on_basis(X.leading_support())                        # needs sage.combinat sage.modules
                    1
                    sage: X.degree()                                                    # needs sage.combinat sage.modules
                    1
                    sage: Y.degree()                                                    # needs sage.combinat sage.modules
                    1
                    sage: L[X, Y]                                                       # needs sage.combinat sage.modules
                    Z
                    sage: Z.degree()                                                    # needs sage.combinat sage.modules
                    2
                """

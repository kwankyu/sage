        ...
        def induced_graded_map(self, other, f):
            ...
            **Example 1.**
            ...
            partitions::
                ...
                sage: A = Modules(QQ).WithBasis().Filtered().example(); A               # needs sage.combinat
                An example of a filtered module with basis: the free module
                 on partitions over Rational Field
                sage: M = A.indices(); M                                                # needs sage.combinat
                Partitions
                sage: p1, p2, p21, p321 = [A.basis()[Partition(i)]                      # needs sage.combinat
    ...
    class ElementMethods:
        ...
        def maximal_degree(self):
            ...
            TESTS::
                ...
                sage: S.zero().degree()                                                 # needs sage.combinat
                Traceback (most recent call last):
                ...
                ValueError: the zero element does not have a well-defined degree
            """
        ...
        class ElementMethods:
            def degree(self):
                ...
                (following the behavior of the exterior algebra)::
                    ...
                    sage: (B[0] + B[2]).degree()                                        # needs sage.combinat sage.modules
                    Traceback (most recent call last):
                    ...
                    ValueError: element is not homogeneous
                ...
                We can still get the maximal degree::
                    ...
                    sage: (B[0] + B[2]).maximal_degree()                                # needs sage.combinat sage.modules
                    2
                """

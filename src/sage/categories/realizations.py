...
class Category_realization_of_parent(Category_over_base, BindableClass):
    ...
    def __init__(self, parent_with_realization):
        ...
        TESTS::
            ...
            Category of realizations of
             The subset algebra of {1, 2, 3} over Rational Field
            sage: isinstance(C, Category_realization_of_parent)                         # needs sage.combinat sage.modules
            True
            sage: C.parent_with_realization                                             # needs sage.combinat sage.modules
            The subset algebra of {1, 2, 3} over Rational Field
            sage: TestSuite(C).run(skip=["_test_category_over_bases"])                  # needs sage.combinat sage.modules
    ...
    def _get_name(self):
        ...
        EXAMPLES::
            ...
            sage: Sym = SymmetricFunctions(QQ); Sym.rename("Sym")                       # needs sage.combinat
            sage: MultiplicativeBasesOnPrimitiveElements(Sym)._get_name()               # needs sage.combinat
    ...
    def _repr_object_names(self):
        ...
        EXAMPLES::
            ...
            ....:     def super_categories(self): return [Objects()]
            sage: Sym = SymmetricFunctions(QQ); Sym.rename("Sym")                       # needs sage.combinat
            sage: C = MultiplicativeBasesOnPrimitiveElements(Sym); C                    # needs sage.combinat
            Category of multiplicative bases on primitive elements of Sym
            sage: C._repr_object_names()                                                # needs sage.combinat

    ...
    class ParentMethods:
        ...
        def convolution_product(self, *maps):
            ...
            composition of the counit with the unit::
                ...
                sage: m = SymmetricFunctionsNonCommutingVariables(QQ).m()               # needs sage.combinat
                sage: T = m.convolution_product()                                       # needs sage.combinat
                sage: [T(m(lam))                                                        # needs sage.combinat
            ...
            non-commuting variables::
                ...
                sage: T = m.convolution_product(Proj2, Id)                              # needs sage.combinat
                sage: [T(m(lam)) for lam in SetPartitions(3)]                           # needs sage.combinat
                [0,
                 m{{1, 2}, {3}} + m{{1, 2, 3}},
                 m{{1, 2}, {3}} + m{{1, 2, 3}},
                 m{{1, 2}, {3}} + m{{1, 2, 3}},
    ...
    class ElementMethods:
        ...
        def adams_operator(self, n):
            ...
            ::
                ...
                sage: S = NonCommutativeSymmetricFunctions(QQ).S()                      # needs sage.combinat
                sage: S[4].adams_operator(5)                                            # needs sage.combinat
            ...
            ::
                ...
                sage: m = SymmetricFunctionsNonCommutingVariables(QQ).m()               # needs sage.combinat
                sage: m[[1,3],[2]].adams_operator(-2)                                   # needs sage.combinat
        ...
        def convolution_product(self, *maps):
            ...
            on Schur functions::
                ...
                sage: s[3].convolution_product(Id, Id)                                  # needs sage.combinat
                2*s[2, 1] + 4*s[3]
                sage: s[3,2].convolution_product(Id) == s[3,2]                          # needs sage.combinat
                True

            The method accepts multiple arguments, or a single argument
            consisting of a list of maps::

                sage: s[3,2].convolution_product(Id, Id)                                # needs sage.combinat
            ...
            the counit and unit::
                ...
                sage: (s[3,2].convolution_product()                                     # needs sage.combinat
            ...
            ::
                ...
                sage: Psi = NonCommutativeSymmetricFunctions(QQ).Psi()                  # needs sage.combinat
                sage: Psi[2,1].convolution_product(Id, Id, Id)                          # needs sage.combinat
                3*Psi[1, 2] + 6*Psi[2, 1]
                sage: (Psi[5,1] - Psi[1,5]).convolution_product(Id, Id, Id)             # needs sage.combinat
                -3*Psi[1, 5] + 3*Psi[5, 1]
            ...
            ::
                ...
                sage: S = NonCommutativeSymmetricFunctions(QQ).S()                      # needs sage.combinat
                sage: S[4].convolution_product([Id] * 5)                                # needs sage.combinat
            ...
            ::
                ...
                sage: (s[3,2].counit().parent()                                         # needs sage.combinat

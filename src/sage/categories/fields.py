...
class Fields(CategoryWithAxiom):
    ...
    EXAMPLES::
        ...
        sage: K(IntegerRing())
        Rational Field
        sage: K(PolynomialRing(GF(3), 'x'))                                             # needs sage.rings.finite_rings
    ...
    def _call_(self, x):
        ...
        EXAMPLES::
            ...
            Rational Field
            sage: K(PolynomialRing(GF(3), 'x')) # indirect doctest                      # needs sage.rings.finite_rings
            Fraction Field of Univariate Polynomial Ring in x over
            Finite Field of size 3
            sage: K(RealField())
            Real Field with 53 bits of precision
    ...
    class ParentMethods:
        ...
        def is_integrally_closed(self):
            ...
            EXAMPLES::
                ...
                True
                sage: Z5 = GF(5); Z5                                                    # needs sage.rings.finite_rings
                Finite Field of size 5
                sage: Z5.is_integrally_closed()                                         # needs sage.rings.finite_rings
                True
            """
            return True
        ...
        def is_perfect(self):
            ...
            EXAMPLES::
                ...
                sage: QQ.is_perfect()
                True
                sage: GF(2).is_perfect()                                                # needs sage.rings.finite_rings
                True
                sage: FunctionField(GF(2), 'x').is_perfect()                            # needs sage.rings.finite_rings
                False
    ...
    class ElementMethods:
        ...
        def lcm(self, other):
            ...
            EXAMPLES::
                ...
                sage: GF(2)(1).lcm(GF(2)(0))                                            # needs sage.rings.finite_rings
                0
                sage: GF(2)(1).lcm(GF(2)(1))                                            # needs sage.rings.finite_rings
                1
        ...
        def factor(self):
            ...
            EXAMPLES::
                ...
                sage: x = GF(7)(5)                                                      # needs sage.rings.finite_rings
                sage: x.factor()                                                        # needs sage.rings.finite_rings
                5
                sage: RR(0).factor()

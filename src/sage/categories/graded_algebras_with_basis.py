    ...
    class ParentMethods:
        ...
        def graded_algebra(self):
            ...
            EXAMPLES::
                ...
                sage: m = SymmetricFunctions(QQ).m()                                    # needs sage.combinat
        ...
        def free_graded_module(self, generator_degrees, names=None):
            ...
            EXAMPLES::
                ...
                sage: Cl = CliffordAlgebra(Q)                                           # needs sage.combinat
                sage: M = Cl.free_graded_module((0, 2, 3))                              # needs sage.combinat
                sage: M.gens()                                                          # needs sage.combinat
                (g[0], g[2], g[3])
                sage: N.<xy, z> = Cl.free_graded_module((1, 2))                         # needs sage.combinat
                sage: N.generators()                                                    # needs sage.combinat
                (xy, z)
            """
            try:

...
class SequencePrettyPrinter(SageObject):
    ...
    def pretty_print(self):
        ...
        output is generated::
            ...
            sage: seq = SequencePrettyPrinter(Graph(), Graph(), edge_labels=True)       # needs sage.plot
            sage: seq.pretty_print()   # does not pass edge_labels to graphics object   # needs sage.plot
            sage: seq._concatenate_graphs().show(edge_labels=True)                      # needs sage.plot
